...
from ../codes/StructureFactor_sphericallyAveraged.BNrGuY.cpp:6:
...
|
../codes/StructureFactor_sphericallyAveraged.BNrGuY.cpp: In static member function ‘static void PLMD::colvar::StructureFactor_sphericallyAveraged::registerKeywords(PLMD::Keywords&)’:
../codes/StructureFactor_sphericallyAveraged.BNrGuY.cpp:77:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
../codes/StructureFactor_sphericallyAveraged.BNrGuY.cpp: In constructor ‘PLMD::colvar::StructureFactor_sphericallyAveraged::StructureFactor_sphericallyAveraged(const PLMD::ActionOptions&)’:
../codes/StructureFactor_sphericallyAveraged.BNrGuY.cpp:184:41: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
184 |     NumAtom_=plumed.getAtoms().getNatoms();
|              ~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
In file included from ../codes/StructureFactor_sphericallyAveraged.BNrGuY.cpp:8:
/home/runner/opt/include/plumed_master/core/PlumedMain.h:106:9: note: declared here
106 |     int getNatoms() const ;
|         ^~~~~~~~~
../codes/StructureFactor_sphericallyAveraged.BNrGuY.cpp:190:108: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
...
|         ^~~~~~~~~
Assembler messages:
Fatal error: can't create plumed_mklib.4iYtWf/../codes/StructureFactor_sphericallyAveraged.o: No such file or directory
...
[pkrvmq0rgcvqdmg:12943] *** Process received signal ***
[pkrvmq0rgcvqdmg:12943] Signal: Aborted (6)
[pkrvmq0rgcvqdmg:12943] Signal code:  (-6)
[pkrvmq0rgcvqdmg:12943] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f8642645330]
[pkrvmq0rgcvqdmg:12943] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f864269eb2c]
[pkrvmq0rgcvqdmg:12943] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f864264527e]
[pkrvmq0rgcvqdmg:12943] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f86426288ff]
[pkrvmq0rgcvqdmg:12943] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f8642aa5ff5]
[pkrvmq0rgcvqdmg:12943] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f8642abb0da]
[pkrvmq0rgcvqdmg:12943] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f8642aa5a55]
[pkrvmq0rgcvqdmg:12943] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f8642aa5a6f]
[pkrvmq0rgcvqdmg:12943] [ 8] plumed_master(+0x146dd)[0x55617aa366dd]
[pkrvmq0rgcvqdmg:12943] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f864262a1ca]
[pkrvmq0rgcvqdmg:12943] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f864262a28b]
[pkrvmq0rgcvqdmg:12943] [11] plumed_master(+0x15365)[0x55617aa37365]
[pkrvmq0rgcvqdmg:12943] *** End of error message ***
</pre>
{% endraw %}
