...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
GraphMol.6P3ZUr.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
GraphMol.6P3ZUr.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
GraphMol.6P3ZUr.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
GraphMol.6P3ZUr.cpp: In member function ‘virtual void PLMD::colvar::MolecularGraphGenerator::calculate()’:
GraphMol.6P3ZUr.cpp:218:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:219:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:224:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
224 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:225:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
225 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:228:3: error: ‘Matrix’ was not declared in this scope
228 |   Matrix<double> dist_mat(_n_node, kcut);
|   ^~~~~~
GraphMol.6P3ZUr.cpp:228:10: error: expected primary-expression before ‘double’
228 |   Matrix<double> dist_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.6P3ZUr.cpp:229:10: error: expected primary-expression before ‘double’
229 |   Matrix<double> idxn_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.6P3ZUr.cpp:230:10: error: expected primary-expression before ‘double’
230 |   Matrix<double> theta1_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.6P3ZUr.cpp:231:10: error: expected primary-expression before ‘double’
231 |   Matrix<double> theta2_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.6P3ZUr.cpp:232:10: error: expected primary-expression before ‘double’
232 |   Matrix<double> theta3_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.6P3ZUr.cpp:233:10: error: expected primary-expression before ‘double’
233 |   Matrix<double> theta4_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.6P3ZUr.cpp:234:16: error: expected primary-expression before ‘>’ token
234 |   Matrix<Vector> dist_deriv_mat(_n_node, kcut);
|                ^
GraphMol.6P3ZUr.cpp:234:18: error: ‘dist_deriv_mat’ was not declared in this scope
234 |   Matrix<Vector> dist_deriv_mat(_n_node, kcut);
|                  ^~~~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:235:16: error: expected primary-expression before ‘>’ token
235 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.6P3ZUr.cpp:235:18: error: ‘theta1_deriv_mat’ was not declared in this scope
235 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:236:16: error: expected primary-expression before ‘>’ token
236 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.6P3ZUr.cpp:236:18: error: ‘theta2_deriv_mat’ was not declared in this scope
236 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:237:16: error: expected primary-expression before ‘>’ token
237 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.6P3ZUr.cpp:237:18: error: ‘theta3_deriv_mat’ was not declared in this scope
237 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:238:16: error: expected primary-expression before ‘>’ token
238 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.6P3ZUr.cpp:238:18: error: ‘theta4_deriv_mat’ was not declared in this scope
238 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:285:11: error: ‘idxn_mat’ was not declared in this scope
285 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
GraphMol.6P3ZUr.cpp:311:11: error: ‘theta1_mat’ was not declared in this scope; did you mean ‘theta1’?
311 |           theta1_mat[i][k-1] += theta1;
|           ^~~~~~~~~~
|           theta1
GraphMol.6P3ZUr.cpp:312:11: error: ‘theta2_mat’ was not declared in this scope; did you mean ‘theta2’?
312 |           theta2_mat[i][k-1] += theta2;
|           ^~~~~~~~~~
|           theta2
GraphMol.6P3ZUr.cpp:313:11: error: ‘theta3_mat’ was not declared in this scope; did you mean ‘theta3’?
313 |           theta3_mat[i][k-1] += theta3;
|           ^~~~~~~~~~
|           theta3
GraphMol.6P3ZUr.cpp:314:11: error: ‘theta4_mat’ was not declared in this scope; did you mean ‘theta4’?
314 |           theta4_mat[i][k-1] += theta4;
|           ^~~~~~~~~~
|           theta4
GraphMol.6P3ZUr.cpp:328:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
328 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:328:18: error: ‘idxn_mat’ was not declared in this scope
328 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
GraphMol.6P3ZUr.cpp:329:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
329 |         comm.Sum(theta1_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:329:18: error: ‘theta1_mat’ was not declared in this scope
329 |         comm.Sum(theta1_mat);
|                  ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:330:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
330 |         comm.Sum(theta2_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:330:18: error: ‘theta2_mat’ was not declared in this scope
330 |         comm.Sum(theta2_mat);
|                  ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:331:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
331 |         comm.Sum(theta3_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:331:18: error: ‘theta3_mat’ was not declared in this scope
331 |         comm.Sum(theta3_mat);
|                  ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:332:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
332 |         comm.Sum(theta4_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:332:18: error: ‘theta4_mat’ was not declared in this scope
332 |         comm.Sum(theta4_mat);
|                  ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:333:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
333 |         comm.Sum(theta1_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:334:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
334 |         comm.Sum(theta2_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:335:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
335 |         comm.Sum(theta3_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:336:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
336 |         comm.Sum(theta4_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:341:26: error: ‘theta1_mat’ was not declared in this scope
341 |   vector<double> input12=theta1_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:342:26: error: ‘theta2_mat’ was not declared in this scope
342 |   vector<double> input13=theta2_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:343:26: error: ‘theta3_mat’ was not declared in this scope
343 |   vector<double> input14=theta3_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:344:26: error: ‘theta4_mat’ was not declared in this scope
344 |   vector<double> input15=theta4_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.6P3ZUr.cpp:345:25: error: ‘idxn_mat’ was not declared in this scope
345 |   vector<double> input2=idxn_mat.getVector();
|                         ^~~~~~~~
GraphMol.6P3ZUr.cpp:434:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
434 |           comm.Sum(virial);
|           ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.6P3ZUr.cpp:435:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[fv-az1781-652:61721] *** Process received signal ***
[fv-az1781-652:61721] Signal: Aborted (6)
[fv-az1781-652:61721] Signal code:  (-6)
[fv-az1781-652:61721] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f623b445330]
[fv-az1781-652:61721] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f623b49eb2c]
[fv-az1781-652:61721] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f623b44527e]
[fv-az1781-652:61721] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f623b4288ff]
[fv-az1781-652:61721] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f623b8a5ff5]
[fv-az1781-652:61721] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f623b8bb0da]
[fv-az1781-652:61721] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f623b8a5a55]
[fv-az1781-652:61721] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f623b8a5a6f]
[fv-az1781-652:61721] [ 8] plumed(+0x146dd)[0x55aadef0b6dd]
[fv-az1781-652:61721] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f623b42a1ca]
[fv-az1781-652:61721] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f623b42a28b]
[fv-az1781-652:61721] [11] plumed(+0x15365)[0x55aadef0c365]
[fv-az1781-652:61721] *** End of error message ***
</pre>
{% endraw %}
