...
<br/><span id="data/WT-metaD.c22star/plumed2.datab_short"><span class="plumedtooltip" style="color:green">ALPHABETA<span class="right">Measures a distance including pbc between the instantaneous values of a set of torsional angles and set of reference values. This action is <a class="toggler" href='javascript:;' onclick='toggleDisplay("data/WT-metaD.c22star/plumed2.datab");'>a shortcut</a>. <a href="https://www.plumed.org/doc-master/user-doc/html/ALPHABETA">More details</a><i></i></span></span> ...
