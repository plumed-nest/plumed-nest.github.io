...
**Last tested:**  22 Aug 2026, 15:04:50
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ALPHABETA,INCLUDE,COORDINATION,GROUP,CS2BACKBONE,METAINFERENCE,PRINT,GYRATION,WHOLEMOLECULES,DISTANCE,PBMETAD,CENTER,MOLINFO" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
