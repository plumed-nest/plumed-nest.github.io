...
**Last tested:**  01 Sep 2026, 14:21:10
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,FIXEDATOM,GROUP,RESTART,DISTANCE,LOWER_WALLS,FIT_TO_TEMPLATE,TORSION,CUSTOM,CENTER,PYTORCH_MODEL,PATH,UPPER_WALLS,OPES_METAD,PRINT,COORDINATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
