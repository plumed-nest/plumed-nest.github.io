...
**Last tested:**  21 Jun 2025, 13:43:26
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CENTER,GROUP,COORDINATION,WHOLEMOLECULES,OPES_METAD_EXPLORE,COM,METAD,UPPER_WALLS,PRINT,LOWER_WALLS,DISTANCE,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
