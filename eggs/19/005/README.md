...
**Last tested:**  21 Jun 2025, 14:00:52
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GYRATION,MOLINFO,DISTANCE,PBMETAD,CS2BACKBONE,PRINT,CENTER,ALPHABETA,COORDINATION,INCLUDE,METAINFERENCE,WHOLEMOLECULES,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
