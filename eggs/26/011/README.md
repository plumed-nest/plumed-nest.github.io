...
|:--------:|:--------:|  
| [biased/plumed.dat](./data/biased/plumed.dat.md) |  [![tested on v2.10](https://img.shields.io/badge/v2.10-failed-red.svg)](data/biased/plumed.dat.plumed.stderr) [![tested on master](https://img.shields.io/badge/master-failed-red.svg)](data/biased/plumed.dat.plumed_master.stderr) [![with LOAD](https://img.shields.io/badge/with-LOAD-yellow.svg)]({{ "/" | absolute_url }}badges) |  
  
**Last tested:**  01 Sep 2026, 14:14:38
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=BIASVALUE,CENTER,PRINT,GROUP,CUSTOM,LOWER_WALLS,LOAD,OPES_METAD_EXPLORE,COORDINATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
**[v1]** 10 Aug 2026:   
...
<img src="./badge.svg" alt="plumeDnest:26.011" id="myBtn" class="badge">
<div id="myModal" class="modal">
  <div class="modal-content">
    <span class="close">&times;</span>
    Markdown<pre>[![plumID:26.011](https://www.plumed-nest.org/eggs/26/011/badge.svg)](https://www.plumed-nest.org/eggs/26/011/)</pre>
