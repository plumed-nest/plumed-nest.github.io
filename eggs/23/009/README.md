...
**Last tested:**  03 Jul 2025, 13:18:34
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMMITTOR,DISTANCE,PRINT,FIXEDATOM,CUSTOM,MATHEVAL,FIT_TO_TEMPLATE,ANGLE,CENTER,ENDPLUMED,GROUP,COORDINATION,MOLINFO,LOWER_WALLS,COMBINE,OPES_METAD,PYTORCH_MODEL,INCLUDE,ENERGY,RMSD,WHOLEMOLECULES,UPPER_WALLS,CONTACTMAP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
