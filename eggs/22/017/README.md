...
**Last tested:**  15 May 2025, 08:20:49
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,COORDINATION,CUSTOM,FIT_TO_TEMPLATE,LOWER_WALLS,PYTORCH_MODEL,PRINT,COMMITTOR,UPPER_WALLS,RMSD,CENTER,MATHEVAL,DISTANCE,WHOLEMOLECULES,GROUP,OPES_METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
