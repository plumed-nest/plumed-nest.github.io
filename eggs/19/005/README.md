...
**Last tested:**  22 May 2025, 18:32:38
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MOLINFO,PRINT,COORDINATION,INCLUDE,GROUP,PBMETAD,METAINFERENCE,DISTANCE,CENTER,ALPHABETA,WHOLEMOLECULES,CS2BACKBONE,GYRATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
