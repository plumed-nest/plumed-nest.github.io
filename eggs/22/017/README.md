...
**Last tested:**  01 Sep 2026, 14:31:08
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,GROUP,FIXEDATOM,COMMITTOR,DISTANCE,LOWER_WALLS,FIT_TO_TEMPLATE,MATHEVAL,RMSD,CENTER,CUSTOM,PYTORCH_MODEL,UPPER_WALLS,OPES_METAD,PRINT,COORDINATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
