...
**Last tested:**  15 May 2025, 08:20:15
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ANGLE,INCLUDE,CENTER,WHOLEMOLECULES,GROUP,CUSTOM,FIXEDATOM,COORDINATION,UPPER_WALLS,RMSD,ENERGY,MOLINFO,FIT_TO_TEMPLATE,ENDPLUMED,PRINT,PYTORCH_MODEL,CONTACTMAP,OPES_METAD,MATHEVAL,COMBINE,DISTANCE,LOWER_WALLS,COMMITTOR" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
