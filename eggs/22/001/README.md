...
**Last tested:**  15 Jan 2026, 17:16:43
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=BF_WAVELETS,COORDINATION,METAD,DISTANCE,UPPER_WALLS,BF_GAUSSIANS,BF_LEGENDRE,ENERGY,PRINT,BF_CUBIC_B_SPLINES,VES_LINEAR_EXPANSION,VES_OUTPUT_BASISFUNCTIONS,TD_UNIFORM,BF_CHEBYSHEV,OPT_ADAM,POSITION,OPT_AVERAGED_SGD,UNITS,TD_WELLTEMPERED,FLUSH,INCLUDE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
