...
**Last tested:**  01 Sep 2026, 14:27:54
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,COORDINATION,PYTORCH_MODEL,CUSTOM,LOWER_WALLS,DISTANCE,FIXEDATOM,PATH,OPES_METAD,UNITS,OPES_METAD_EXPLORE,WHOLEMOLECULES,FIT_TO_TEMPLATE,TORSION,CENTER,PRINT,UPPER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
