...
<div class="headerInfo" id="value_details_data/EnhancedCoexistence/Liq-Ih/3-BiasedCoexistence/COEX_1.0atm/260.0K/plumed.start.dat"> Click on the labels of the actions for more information on what each action computes </div>
