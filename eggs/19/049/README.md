...
**Last tested:**  25 Jul 2025, 11:55:54
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DFSCLUSTERING,CLUSTER_DISTRIBUTION,ONES,CONTACT_MATRIX,LOCAL_Q6,MATRIX_VECTOR_PRODUCT,MORE_THAN,CUSTOM,OUTPUT_CLUSTER,CLUSTER_NATOMS,CLUSTER_PROPERTIES,PRINT,COORDINATIONNUMBER,METAD,SMAC,Q6,DISTANCES,OUTER_PRODUCT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
