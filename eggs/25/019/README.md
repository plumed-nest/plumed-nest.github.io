...
**Last tested:**  15 Jan 2026, 17:00:16
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPES_EXPANDED,CUSTOM,DISTANCE,OPES_METAD_EXPLORE,COMBINE,RMSD,ECV_MULTITHERMAL,MOLINFO,COORDINATION,CENTER,GROUP,PRINT,GHOST,ENERGY" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
