...
**Last tested:**  29 Jun 2026, 10:37:04
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ALPHABETA,WHOLEMOLECULES,INCLUDE,PRINT,CS2BACKBONE,CENTER,COORDINATION,GROUP,MOLINFO,PBMETAD,GYRATION,DISTANCE,METAINFERENCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
