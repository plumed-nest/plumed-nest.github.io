...
**Last tested:**  20 Apr 2026, 09:46:06
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,METAINFERENCE,MOLINFO,DISTANCE,GYRATION,INCLUDE,ALPHABETA,GROUP,WHOLEMOLECULES,PBMETAD,CENTER,CS2BACKBONE,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
