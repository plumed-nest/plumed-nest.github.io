...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
GraphMol.TZsrhi.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
GraphMol.TZsrhi.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
GraphMol.TZsrhi.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
GraphMol.TZsrhi.cpp: In member function ‘virtual void PLMD::colvar::MolecularGraphGenerator::calculate()’:
GraphMol.TZsrhi.cpp:218:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:219:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:224:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
224 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:225:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
225 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:228:3: error: ‘Matrix’ was not declared in this scope
228 |   Matrix<double> dist_mat(_n_node, kcut);
|   ^~~~~~
GraphMol.TZsrhi.cpp:228:10: error: expected primary-expression before ‘double’
228 |   Matrix<double> dist_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.TZsrhi.cpp:229:10: error: expected primary-expression before ‘double’
229 |   Matrix<double> idxn_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.TZsrhi.cpp:230:10: error: expected primary-expression before ‘double’
230 |   Matrix<double> theta1_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.TZsrhi.cpp:231:10: error: expected primary-expression before ‘double’
231 |   Matrix<double> theta2_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.TZsrhi.cpp:232:10: error: expected primary-expression before ‘double’
232 |   Matrix<double> theta3_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.TZsrhi.cpp:233:10: error: expected primary-expression before ‘double’
233 |   Matrix<double> theta4_mat(_n_node, kcut);
|          ^~~~~~
GraphMol.TZsrhi.cpp:234:16: error: expected primary-expression before ‘>’ token
234 |   Matrix<Vector> dist_deriv_mat(_n_node, kcut);
|                ^
GraphMol.TZsrhi.cpp:234:18: error: ‘dist_deriv_mat’ was not declared in this scope
234 |   Matrix<Vector> dist_deriv_mat(_n_node, kcut);
|                  ^~~~~~~~~~~~~~
GraphMol.TZsrhi.cpp:235:16: error: expected primary-expression before ‘>’ token
235 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.TZsrhi.cpp:235:18: error: ‘theta1_deriv_mat’ was not declared in this scope
235 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.TZsrhi.cpp:236:16: error: expected primary-expression before ‘>’ token
236 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.TZsrhi.cpp:236:18: error: ‘theta2_deriv_mat’ was not declared in this scope
236 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.TZsrhi.cpp:237:16: error: expected primary-expression before ‘>’ token
237 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.TZsrhi.cpp:237:18: error: ‘theta3_deriv_mat’ was not declared in this scope
237 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.TZsrhi.cpp:238:16: error: expected primary-expression before ‘>’ token
238 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMol.TZsrhi.cpp:238:18: error: ‘theta4_deriv_mat’ was not declared in this scope
238 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMol.TZsrhi.cpp:285:11: error: ‘idxn_mat’ was not declared in this scope
285 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
GraphMol.TZsrhi.cpp:311:11: error: ‘theta1_mat’ was not declared in this scope; did you mean ‘theta1’?
311 |           theta1_mat[i][k-1] += theta1;
|           ^~~~~~~~~~
|           theta1
GraphMol.TZsrhi.cpp:312:11: error: ‘theta2_mat’ was not declared in this scope; did you mean ‘theta2’?
312 |           theta2_mat[i][k-1] += theta2;
|           ^~~~~~~~~~
|           theta2
GraphMol.TZsrhi.cpp:313:11: error: ‘theta3_mat’ was not declared in this scope; did you mean ‘theta3’?
313 |           theta3_mat[i][k-1] += theta3;
|           ^~~~~~~~~~
|           theta3
GraphMol.TZsrhi.cpp:314:11: error: ‘theta4_mat’ was not declared in this scope; did you mean ‘theta4’?
314 |           theta4_mat[i][k-1] += theta4;
|           ^~~~~~~~~~
|           theta4
GraphMol.TZsrhi.cpp:328:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
328 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:328:18: error: ‘idxn_mat’ was not declared in this scope
328 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
GraphMol.TZsrhi.cpp:329:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
329 |         comm.Sum(theta1_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:329:18: error: ‘theta1_mat’ was not declared in this scope
329 |         comm.Sum(theta1_mat);
|                  ^~~~~~~~~~
GraphMol.TZsrhi.cpp:330:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
330 |         comm.Sum(theta2_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:330:18: error: ‘theta2_mat’ was not declared in this scope
330 |         comm.Sum(theta2_mat);
|                  ^~~~~~~~~~
GraphMol.TZsrhi.cpp:331:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
331 |         comm.Sum(theta3_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:331:18: error: ‘theta3_mat’ was not declared in this scope
331 |         comm.Sum(theta3_mat);
|                  ^~~~~~~~~~
GraphMol.TZsrhi.cpp:332:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
332 |         comm.Sum(theta4_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:332:18: error: ‘theta4_mat’ was not declared in this scope
332 |         comm.Sum(theta4_mat);
|                  ^~~~~~~~~~
GraphMol.TZsrhi.cpp:333:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
333 |         comm.Sum(theta1_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:334:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
334 |         comm.Sum(theta2_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:335:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
335 |         comm.Sum(theta3_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:336:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
336 |         comm.Sum(theta4_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:341:26: error: ‘theta1_mat’ was not declared in this scope
341 |   vector<double> input12=theta1_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.TZsrhi.cpp:342:26: error: ‘theta2_mat’ was not declared in this scope
342 |   vector<double> input13=theta2_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.TZsrhi.cpp:343:26: error: ‘theta3_mat’ was not declared in this scope
343 |   vector<double> input14=theta3_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.TZsrhi.cpp:344:26: error: ‘theta4_mat’ was not declared in this scope
344 |   vector<double> input15=theta4_mat.getVector();
|                          ^~~~~~~~~~
GraphMol.TZsrhi.cpp:345:25: error: ‘idxn_mat’ was not declared in this scope
345 |   vector<double> input2=idxn_mat.getVector();
|                         ^~~~~~~~
GraphMol.TZsrhi.cpp:434:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
434 |           comm.Sum(virial);
|           ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.TZsrhi.cpp:435:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[pkrvmbietmlfzoi:07448] *** Process received signal ***
[pkrvmbietmlfzoi:07448] Signal: Aborted (6)
[pkrvmbietmlfzoi:07448] Signal code:  (-6)
[pkrvmbietmlfzoi:07448] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fdb76845330]
[pkrvmbietmlfzoi:07448] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fdb7689eb2c]
[pkrvmbietmlfzoi:07448] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fdb7684527e]
[pkrvmbietmlfzoi:07448] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fdb768288ff]
[pkrvmbietmlfzoi:07448] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fdb76ca5ff5]
[pkrvmbietmlfzoi:07448] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fdb76cbb0da]
[pkrvmbietmlfzoi:07448] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fdb76ca5a55]
[pkrvmbietmlfzoi:07448] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fdb76ca5a6f]
[pkrvmbietmlfzoi:07448] [ 8] plumed(+0x146dd)[0x558e3a8f26dd]
[pkrvmbietmlfzoi:07448] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fdb7682a1ca]
[pkrvmbietmlfzoi:07448] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fdb7682a28b]
[pkrvmbietmlfzoi:07448] [11] plumed(+0x15365)[0x558e3a8f3365]
[pkrvmbietmlfzoi:07448] *** End of error message ***
</pre>
{% endraw %}
