...
**Last tested:**  15 Jan 2026, 17:20:55
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=BIASVALUE,DISTANCE,COMMITTOR,READ,MATHEVAL,CONVERT_TO_FES,REWEIGHT_BIAS,EXTERNAL,PRINT,HISTOGRAM,DUMPGRID,TORSION,REWEIGHT_METAD,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
