...
from GraphMolNoDeriv.6jw93P.cpp:32:
...
from GraphMolNoDeriv.6jw93P.cpp:26:
...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
GraphMolNoDeriv.6jw93P.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
GraphMolNoDeriv.6jw93P.cpp:45:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
GraphMolNoDeriv.6jw93P.cpp:45:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
45 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
GraphMolNoDeriv.6jw93P.cpp: In static member function ‘static void PLMD::colvar::MolecularGraphGenerator::registerKeywords(PLMD::Keywords&)’:
GraphMolNoDeriv.6jw93P.cpp:115:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp: In member function ‘virtual void PLMD::colvar::MolecularGraphGenerator::calculate()’:
GraphMolNoDeriv.6jw93P.cpp:218:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:219:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:224:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
224 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:225:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
225 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:228:3: error: ‘Matrix’ was not declared in this scope
228 |   Matrix<double> idxn_mat(_n_node, kcut);
|   ^~~~~~
GraphMolNoDeriv.6jw93P.cpp:228:10: error: expected primary-expression before ‘double’
228 |   Matrix<double> idxn_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.6jw93P.cpp:229:10: error: expected primary-expression before ‘double’
229 |   Matrix<double> theta1_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.6jw93P.cpp:230:10: error: expected primary-expression before ‘double’
230 |   Matrix<double> theta2_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.6jw93P.cpp:231:10: error: expected primary-expression before ‘double’
231 |   Matrix<double> theta3_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.6jw93P.cpp:232:10: error: expected primary-expression before ‘double’
232 |   Matrix<double> theta4_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.6jw93P.cpp:233:16: error: expected primary-expression before ‘>’ token
233 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.6jw93P.cpp:233:18: error: ‘theta1_deriv_mat’ was not declared in this scope
233 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:234:16: error: expected primary-expression before ‘>’ token
234 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.6jw93P.cpp:234:18: error: ‘theta2_deriv_mat’ was not declared in this scope
234 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:235:16: error: expected primary-expression before ‘>’ token
235 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.6jw93P.cpp:235:18: error: ‘theta3_deriv_mat’ was not declared in this scope
235 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:236:16: error: expected primary-expression before ‘>’ token
236 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.6jw93P.cpp:236:18: error: ‘theta4_deriv_mat’ was not declared in this scope
236 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:283:11: error: ‘idxn_mat’ was not declared in this scope
283 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:309:11: error: ‘theta1_mat’ was not declared in this scope; did you mean ‘theta1’?
309 |           theta1_mat[i][k-1] += theta1;
|           ^~~~~~~~~~
|           theta1
GraphMolNoDeriv.6jw93P.cpp:310:11: error: ‘theta2_mat’ was not declared in this scope; did you mean ‘theta2’?
310 |           theta2_mat[i][k-1] += theta2;
|           ^~~~~~~~~~
|           theta2
GraphMolNoDeriv.6jw93P.cpp:311:11: error: ‘theta3_mat’ was not declared in this scope; did you mean ‘theta3’?
311 |           theta3_mat[i][k-1] += theta3;
|           ^~~~~~~~~~
|           theta3
GraphMolNoDeriv.6jw93P.cpp:312:11: error: ‘theta4_mat’ was not declared in this scope; did you mean ‘theta4’?
312 |           theta4_mat[i][k-1] += theta4;
|           ^~~~~~~~~~
|           theta4
GraphMolNoDeriv.6jw93P.cpp:327:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
327 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:327:18: error: ‘idxn_mat’ was not declared in this scope
327 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:328:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
328 |         comm.Sum(theta1_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:328:18: error: ‘theta1_mat’ was not declared in this scope
328 |         comm.Sum(theta1_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:329:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
329 |         comm.Sum(theta2_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:329:18: error: ‘theta2_mat’ was not declared in this scope
329 |         comm.Sum(theta2_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:330:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
330 |         comm.Sum(theta3_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:330:18: error: ‘theta3_mat’ was not declared in this scope
330 |         comm.Sum(theta3_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:331:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
331 |         comm.Sum(theta4_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:331:18: error: ‘theta4_mat’ was not declared in this scope
331 |         comm.Sum(theta4_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:332:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
332 |         comm.Sum(theta1_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:333:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
333 |         comm.Sum(theta2_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:334:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
334 |         comm.Sum(theta3_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:335:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
335 |         comm.Sum(theta4_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:340:26: error: ‘theta1_mat’ was not declared in this scope
340 |   vector<double> input12=theta1_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:341:26: error: ‘theta2_mat’ was not declared in this scope
341 |   vector<double> input13=theta2_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:342:26: error: ‘theta3_mat’ was not declared in this scope
342 |   vector<double> input14=theta3_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:343:26: error: ‘theta4_mat’ was not declared in this scope
343 |   vector<double> input15=theta4_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.6jw93P.cpp:344:25: error: ‘idxn_mat’ was not declared in this scope
...
[fv-az1719-476:07175] *** Process received signal ***
[fv-az1719-476:07175] Signal: Aborted (6)
[fv-az1719-476:07175] Signal code:  (-6)
[fv-az1719-476:07175] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f5d73445330]
[fv-az1719-476:07175] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f5d7349eb2c]
[fv-az1719-476:07175] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f5d7344527e]
[fv-az1719-476:07175] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f5d734288ff]
[fv-az1719-476:07175] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f5d738a5ff5]
[fv-az1719-476:07175] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f5d738bb0da]
[fv-az1719-476:07175] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f5d738a5a55]
[fv-az1719-476:07175] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f5d738a5a6f]
[fv-az1719-476:07175] [ 8] plumed_master(+0x146dd)[0x563cd23586dd]
[fv-az1719-476:07175] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f5d7342a1ca]
[fv-az1719-476:07175] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f5d7342a28b]
[fv-az1719-476:07175] [11] plumed_master(+0x15365)[0x563cd2359365]
[fv-az1719-476:07175] *** End of error message ***
</pre>
{% endraw %}
