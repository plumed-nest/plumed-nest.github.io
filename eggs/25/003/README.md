...
**Last tested:**  29 Jun 2026, 10:11:35
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMMITTOR,WHOLEMOLECULES,ENERGY,TORSION,PRINT,GROUP,ENDPLUMED,CUSTOM,DISTANCE,OPES_METAD,PYTORCH_MODEL,MOLINFO,MATHEVAL,COMBINE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
