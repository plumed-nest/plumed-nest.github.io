...
**Last tested:**  29 May 2025, 07:14:01
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CENTER,PYTORCH_MODEL,UPPER_WALLS,LOWER_WALLS,OPES_METAD,RMSD,WHOLEMOLECULES,GROUP,DISTANCE,CUSTOM,FIT_TO_TEMPLATE,COORDINATION,PRINT,COMMITTOR,MATHEVAL,FIXEDATOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
