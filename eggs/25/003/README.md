...
**Last tested:**  20 Apr 2026, 09:18:05
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENERGY,PRINT,MOLINFO,ENDPLUMED,MATHEVAL,TORSION,CUSTOM,PYTORCH_MODEL,COMMITTOR,OPES_METAD,WHOLEMOLECULES,DISTANCE,COMBINE,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
