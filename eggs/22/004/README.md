...
**Last tested:**  17 Jul 2025, 15:12:59
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,COORDINATION,OPES_METAD,COM,LOAD,PRINT,OPES_METAD_EXPLORE,UPPER_WALLS,CUSTOM,MATHEVAL,LOWER_WALLS,DISTANCE,PYTORCH_MODEL,UNITS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
