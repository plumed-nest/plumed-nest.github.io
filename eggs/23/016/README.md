...
**Publication:** [J. C. Calderón, P. Ibrahim, D. Gobbo, F. L. Gervasio, T. Clark, Activation/Deactivation Free-Energy Profiles for the β
                    <sub>2</sub>
                    -Adrenergic Receptor: Ligand Modes of Action. Journal of Chemical Information and Modeling 63, 6332–6343 (2023)](http://dx.doi.org/10.1021/acs.jcim.3c00805)  
...
**Last tested:**  22 Aug 2026, 14:44:01
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=READ,MOLINFO,HISTOGRAM,DUMPGRID,WHOLEMOLECULES,MATHEVAL,PRINT,RMSD,CONVERT_TO_FES,DISTANCE,REWEIGHT_METAD,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
