...
**Last tested:**  25 Jul 2025, 11:36:36
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=TORSION,PATH,WHOLEMOLECULES,OPES_METAD_EXPLORE,OPES_METAD,CUSTOM,GROUP,DISTANCE,FIT_TO_TEMPLATE,UNITS,PRINT,PYTORCH_MODEL,UPPER_WALLS,FIXEDATOM,COORDINATION,LOWER_WALLS,CENTER" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
