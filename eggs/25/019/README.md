...
**Last tested:**  10 Mar 2026, 11:00:37
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=RMSD,COORDINATION,OPES_METAD_EXPLORE,GROUP,DISTANCE,MOLINFO,PRINT,OPES_EXPANDED,COMBINE,CUSTOM,ENERGY,CENTER,GHOST,ECV_MULTITHERMAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
