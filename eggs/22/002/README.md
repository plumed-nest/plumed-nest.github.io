...
**Last tested:**  21 Jun 2025, 13:44:19
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,ENERGY,MATHEVAL,LOAD,PRINT,CENTER,ENDPLUMED,COORDINATION,FIT_TO_TEMPLATE,PYTORCH_MODEL,UPPER_WALLS,GROUP,COMMITTOR,FLUSH,FIXEDATOM,DISTANCE,ANGLE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
