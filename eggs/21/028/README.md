...
**Last tested:**  29 May 2025, 07:06:57
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=TORSION,FIXEDATOM,DISTANCES,GROUP,WHOLEMOLECULES,PYTORCH_MODEL,CENTER,DISTANCE,UPPER_WALLS,PRINT,ENDPLUMED,LOWER_WALLS,LOAD,FIT_TO_TEMPLATE,COORDINATION,OPES_METAD,ANGLE,UNITS,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
