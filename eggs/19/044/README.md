...
**Last tested:**  06 May 2025, 07:11:54
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=VES_LINEAR_EXPANSION,READ,CONVERT_TO_FES,REWEIGHT_BIAS,PRINT,VOLUME,BF_LEGENDRE,RESTART,ENERGY,OPT_DUMMY,OPT_AVERAGED_SGD,REWEIGHT_TEMP_PRESS,AVERAGE,DUMPGRID,HISTOGRAM,COMBINE,TD_MULTITHERMAL_MULTIBARIC" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
