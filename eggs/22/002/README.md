...
**Last tested:**  27 Jul 2026, 19:31:23
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,CENTER,COORDINATION,ENDPLUMED,DISTANCE,UPPER_WALLS,PYTORCH_MODEL,FIT_TO_TEMPLATE,ENERGY,COMMITTOR,ANGLE,FIXEDATOM,LOAD,MATHEVAL,FLUSH,WHOLEMOLECULES,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
