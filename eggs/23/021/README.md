...
**Last tested:**  20 Apr 2026, 09:27:48
  
**Project description and instructions**  
Input files to reproduce results of the paper "Into the dynamics of rotaxanes at atomistic resolution"
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UPPER_WALLS,MATHEVAL,DISTANCE,TORSION,CUSTOM,PRINT,METAD,FIXEDATOM,CENTER" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
