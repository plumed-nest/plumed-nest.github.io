...
**Last tested:**  15 Jan 2026, 17:12:17
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GYRATION,METAD,CONVERT_TO_FES,COMBINE,DISTANCES,INCLUDE,COM,DUMPGRID,GROUP,PRINT,REWEIGHT_BIAS,HISTOGRAM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
