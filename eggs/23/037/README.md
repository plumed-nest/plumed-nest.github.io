...
**Last tested:**  06 May 2025, 06:46:51
  
**Project description and instructions**  
Initial configurations, run files for GROMACS and two complete examples of metadynamics are included.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COM,DISTANCE,PRINT,LOWER_WALLS,UPPER_WALLS,PBMETAD,GYRATION,MOLINFO" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
