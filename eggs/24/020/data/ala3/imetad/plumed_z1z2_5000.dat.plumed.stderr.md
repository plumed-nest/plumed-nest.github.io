...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.PDAdTQ.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.PDAdTQ.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.PDAdTQ.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.PDAdTQ.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.PDAdTQ.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.PDAdTQ.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.PDAdTQ.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.PDAdTQ.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.PDAdTQ.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.PDAdTQ.cpp:197:3: error: ‘Matrix’ was not declared in this scope
197 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.PDAdTQ.cpp:197:10: error: expected primary-expression before ‘double’
197 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.PDAdTQ.cpp:198:16: error: expected primary-expression before ‘>’ token
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.PDAdTQ.cpp:198:18: error: ‘dist_deriv_mat’ was not declared in this scope
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.PDAdTQ.cpp:213:7: error: ‘dist_mat’ was not declared in this scope
213 |       dist_mat[i][j] = value;
|       ^~~~~~~~
Graph.PDAdTQ.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
Graph.PDAdTQ.cpp:232:19: error: ‘dist_mat’ was not declared in this scope
...
[pkrvmf6wy0o8zjz:63132] *** Process received signal ***
[pkrvmf6wy0o8zjz:63132] Signal: Aborted (6)
[pkrvmf6wy0o8zjz:63132] Signal code:  (-6)
[pkrvmf6wy0o8zjz:63132] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f5fa4645330]
[pkrvmf6wy0o8zjz:63132] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f5fa469eb2c]
[pkrvmf6wy0o8zjz:63132] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f5fa464527e]
[pkrvmf6wy0o8zjz:63132] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f5fa46288ff]
[pkrvmf6wy0o8zjz:63132] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f5fa4aa5ff5]
[pkrvmf6wy0o8zjz:63132] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f5fa4abb0da]
[pkrvmf6wy0o8zjz:63132] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f5fa4aa5a55]
[pkrvmf6wy0o8zjz:63132] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f5fa4aa5a6f]
[pkrvmf6wy0o8zjz:63132] [ 8] plumed(+0x146dd)[0x55d9f0c886dd]
[pkrvmf6wy0o8zjz:63132] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f5fa462a1ca]
[pkrvmf6wy0o8zjz:63132] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f5fa462a28b]
[pkrvmf6wy0o8zjz:63132] [11] plumed(+0x15365)[0x55d9f0c89365]
[pkrvmf6wy0o8zjz:63132] *** End of error message ***
</pre>
{% endraw %}
