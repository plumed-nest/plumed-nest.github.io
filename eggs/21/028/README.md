...
**Last tested:**  27 Jul 2026, 19:35:51
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PYTORCH_MODEL,ENDPLUMED,MATHEVAL,GROUP,PRINT,UNITS,WHOLEMOLECULES,LOWER_WALLS,DISTANCES,FIXEDATOM,COORDINATION,OPES_METAD,CENTER,FIT_TO_TEMPLATE,UPPER_WALLS,TORSION,LOAD,DISTANCE,ANGLE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
