...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.l5ytE7.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.l5ytE7.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.l5ytE7.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.l5ytE7.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.l5ytE7.cpp:82:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
82 |   bool serial,pbc;
|               ^~~
Graph.l5ytE7.cpp:82:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
82 |   bool serial,pbc;
|        ^~~~~~
Graph.l5ytE7.cpp:107:1: warning:   when initialized here [-Wreorder]
107 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.l5ytE7.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.l5ytE7.cpp:179:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.l5ytE7.cpp:180:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
180 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.l5ytE7.cpp:185:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
185 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.l5ytE7.cpp:186:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
186 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.l5ytE7.cpp:189:3: error: ‘Matrix’ was not declared in this scope
189 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.l5ytE7.cpp:189:10: error: expected primary-expression before ‘double’
189 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.l5ytE7.cpp:190:10: error: expected primary-expression before ‘double’
190 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.l5ytE7.cpp:191:16: error: expected primary-expression before ‘>’ token
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.l5ytE7.cpp:191:18: error: ‘dist_deriv_mat’ was not declared in this scope
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.l5ytE7.cpp:211:11: error: ‘dist_mat’ was not declared in this scope
211 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.l5ytE7.cpp:212:11: error: ‘idxn_mat’ was not declared in this scope
212 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.l5ytE7.cpp:218:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
218 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.l5ytE7.cpp:218:18: error: ‘dist_mat’ was not declared in this scope
218 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.l5ytE7.cpp:219:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.l5ytE7.cpp:219:18: error: ‘idxn_mat’ was not declared in this scope
219 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.l5ytE7.cpp:220:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
220 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.l5ytE7.cpp:224:25: error: ‘dist_mat’ was not declared in this scope
224 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.l5ytE7.cpp:225:25: error: ‘idxn_mat’ was not declared in this scope
...
[runnervmw9dnm:07076] *** Process received signal ***
[runnervmw9dnm:07076] Signal: Aborted (6)
[runnervmw9dnm:07076] Signal code:  (-6)
[runnervmw9dnm:07076] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fd452445330]
[runnervmw9dnm:07076] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fd45249eb2c]
[runnervmw9dnm:07076] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fd45244527e]
[runnervmw9dnm:07076] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fd4524288ff]
[runnervmw9dnm:07076] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fd4528a5ff5]
[runnervmw9dnm:07076] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fd4528bb0da]
[runnervmw9dnm:07076] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fd4528a5a55]
[runnervmw9dnm:07076] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fd4528a5a6f]
[runnervmw9dnm:07076] [ 8] plumed(+0x146dd)[0x55bb58e6c6dd]
[runnervmw9dnm:07076] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fd45242a1ca]
[runnervmw9dnm:07076] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fd45242a28b]
[runnervmw9dnm:07076] [11] plumed(+0x15365)[0x55bb58e6d365]
[runnervmw9dnm:07076] *** End of error message ***
</pre>
{% endraw %}
