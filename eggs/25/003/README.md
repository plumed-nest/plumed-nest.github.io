...
**Last tested:**  22 Aug 2026, 14:40:32
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,PRINT,ENERGY,OPES_METAD,COMBINE,GROUP,TORSION,MATHEVAL,PYTORCH_MODEL,MOLINFO,COMMITTOR,DISTANCE,ENDPLUMED,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
