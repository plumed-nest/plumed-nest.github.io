...
**Last tested:**  25 Jul 2025, 11:32:55
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PYTORCH_MODEL,TORSION,PRINT,MATHEVAL,ENERGY,COMMITTOR,DISTANCE,GROUP,COMBINE,OPES_METAD,CUSTOM,WHOLEMOLECULES,MOLINFO,ENDPLUMED" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
