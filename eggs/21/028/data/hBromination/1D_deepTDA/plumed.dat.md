...
**Source:** hBromination/1D_deepTDA/plumed.dat  
...
nncv: <a href="https://plumed.github.io/doc-master/user-doc/html/_p_y_t_o_r_c_h__m_o_d_e_l.html">PYTORCH_MODEL</a> MODEL=deepTDA_hBromination_1D.pt ARG=cc2.*,cb2.*,ch2.*,bh2.*
...
<a href="https://plumed.github.io/doc-master/user-doc/html/_p_r_i_n_t.html">PRINT</a> STRIDE=500 FILE=colvar ARG=nncv.node-0,opes.*,d1,d2,d3,d4,d5,wallHH.*,uwall.*,wallCe1H1.*,wallCe2H2.*,wallCmH1.*
</pre>{% endraw %}
