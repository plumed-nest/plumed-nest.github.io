...
**Last tested:**  17 Jul 2025, 15:03:18
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=RESTART,OPES_METAD,PATH,CUSTOM,FIT_TO_TEMPLATE,WHOLEMOLECULES,GROUP,TORSION,CENTER,LOWER_WALLS,PYTORCH_MODEL,UPPER_WALLS,FIXEDATOM,PRINT,DISTANCE,COORDINATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
