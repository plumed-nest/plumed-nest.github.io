...
**Last tested:**  29 May 2025, 07:16:31
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENDPLUMED,LOAD,CENTER,PYTORCH_MODEL,UPPER_WALLS,WHOLEMOLECULES,GROUP,DISTANCE,FIT_TO_TEMPLATE,COORDINATION,ANGLE,PRINT,MATHEVAL,COMMITTOR,ENERGY,FLUSH,FIXEDATOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
