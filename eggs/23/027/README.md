...
**Last tested:**  27 Jun 2025, 17:47:23
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=LOCAL_Q3,CLUSTER_DISTRIBUTION,LOAD,UNITS,GROUP,DENSITY,FIXEDATOM,HISTOGRAM,CLUSTER_NATOMS,DUMPGRID,DFSCLUSTERING,LOCAL_AVERAGE,Q3,AROUND,CONTACT_MATRIX,RESTRAINT,COORDINATIONNUMBER,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
