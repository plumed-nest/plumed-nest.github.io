...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
GraphMol.Laenhy.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
GraphMol.Laenhy.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
GraphMol.Laenhy.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
GraphMol.Laenhy.cpp: In static member function ‘static void PLMD::colvar::MolecularGraphGenerator::registerKeywords(PLMD::Keywords&)’:
GraphMol.Laenhy.cpp:116:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
GraphMol.Laenhy.cpp: In member function ‘virtual void PLMD::colvar::MolecularGraphGenerator::calculate()’:
GraphMol.Laenhy.cpp:218:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:219:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:224:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
224 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:225:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
225 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:328:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
328 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:329:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
329 |         comm.Sum(theta1_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:330:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
330 |         comm.Sum(theta2_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:331:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
331 |         comm.Sum(theta3_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:332:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
332 |         comm.Sum(theta4_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:333:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
333 |         comm.Sum(theta1_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:334:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
334 |         comm.Sum(theta2_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:335:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
335 |         comm.Sum(theta3_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:336:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
336 |         comm.Sum(theta4_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:434:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
434 |           comm.Sum(virial);
|           ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMol.Laenhy.cpp:435:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[runnervm76f27:06772] *** Process received signal ***
[runnervm76f27:06772] Signal: Aborted (6)
[runnervm76f27:06772] Signal code:  (-6)
[runnervm76f27:06772] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7ff6d8e45330]
[runnervm76f27:06772] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7ff6d8e9ec0c]
[runnervm76f27:06772] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7ff6d8e4527e]
[runnervm76f27:06772] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7ff6d8e288ff]
[runnervm76f27:06772] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7ff6d92a5ff5]
[runnervm76f27:06772] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7ff6d92bb0da]
[runnervm76f27:06772] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7ff6d92a5a55]
[runnervm76f27:06772] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7ff6d92a5a6f]
[runnervm76f27:06772] [ 8] plumed_master(+0x146dd)[0x559e38cc96dd]
[runnervm76f27:06772] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7ff6d8e2a1ca]
[runnervm76f27:06772] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7ff6d8e2a28b]
[runnervm76f27:06772] [11] plumed_master(+0x15365)[0x559e38cca365]
[runnervm76f27:06772] *** End of error message ***
</pre>
{% endraw %}
