...
**Last tested:**  27 Jun 2025, 17:50:34
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=LOWER_WALLS,DISTANCE,CUSTOM,WHOLEMOLECULES,UPPER_WALLS,COORDINATION,CENTER,PRINT,OPES_METAD_EXPLORE,COM,METAD,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
