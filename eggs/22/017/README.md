...
**Last tested:**  11 Nov 2025, 10:01:03
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,PRINT,GROUP,MATHEVAL,LOWER_WALLS,WHOLEMOLECULES,PYTORCH_MODEL,COORDINATION,DISTANCE,UPPER_WALLS,COMMITTOR,RMSD,CUSTOM,CENTER,OPES_METAD,FIT_TO_TEMPLATE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
