...
**Last tested:**  06 May 2025, 07:02:34
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,CENTER,LOWER_WALLS,TORSION,PATH,PYTORCH_MODEL,DISTANCE,GROUP,PRINT,FIT_TO_TEMPLATE,WHOLEMOLECULES,OPES_METAD,UNITS,OPES_METAD_EXPLORE,UPPER_WALLS,FIXEDATOM,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
