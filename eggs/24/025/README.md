...
**Last tested:**  03 Feb 2026, 21:10:20
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,FIXEDATOM,CUSTOM,COORDINATION,LOWER_WALLS,PYTORCH_MODEL,PATH,TORSION,CENTER,FIT_TO_TEMPLATE,DISTANCE,RESTART,UPPER_WALLS,WHOLEMOLECULES,GROUP,OPES_METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
