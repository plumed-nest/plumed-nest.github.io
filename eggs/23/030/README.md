...
**Last tested:**  15 Jan 2026, 17:08:45
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WRAPAROUND,MOLINFO,OPES_METAD,CUSTOM,CENTER,COM,OPES_METAD_EXPLORE,LOWER_WALLS,UPPER_WALLS,PRINT,ENDPLUMED,TORSION,FLUSH,COMMITTOR,BIASVALUE,MATHEVAL,ENERGY,GROUP,POSITION,UNITS,COORDINATION,DISTANCE,FIT_TO_TEMPLATE,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
