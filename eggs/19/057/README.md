...
**Last tested:**  15 Jan 2026, 17:32:51
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PBMETAD,COORDINATION,ANGLE,MOLINFO,GROUP,ALPHABETA,CENTER,SAXS,ENSEMBLE,INCLUDE,COMBINE,PRINT,BIASVALUE,WHOLEMOLECULES,ENDPLUMED,MATHEVAL,STATS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
