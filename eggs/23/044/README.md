...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=READ,METAD,DUMPGRID,COORDINATION,CONVERT_TO_FES,HISTOGRAM,PRINT,COMMITTOR,GROUP,ENDPLUMED" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
