...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,Q6,LOCAL_AVERAGE,COMBINE,LOCAL_Q6,MFILTER_LESS,CONTACT_MATRIX,MFILTER_MORE,DFSCLUSTERING,GROUP,CLUSTER_NATOMS,Q4,COORDINATIONNUMBER,LOCAL_Q4" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
