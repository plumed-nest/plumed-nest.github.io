...
**Last tested:**  17 Jul 2025, 15:24:44
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,DUMPGRID,ENERGY,RANDOM_EXCHANGES,INCLUDE,UPPER_WALLS,METAD,GROUP,LOWER_WALLS,COORDINATION,HISTOGRAM,WHOLEMOLECULES,PUCKERING,DISTANCE,MOLINFO,REWEIGHT_METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
