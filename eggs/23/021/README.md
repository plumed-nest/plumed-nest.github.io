...
**Last tested:**  03 Feb 2026, 21:07:45
  
**Project description and instructions**  
Input files to reproduce results of the paper "Into the dynamics of rotaxanes at atomistic resolution"
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CUSTOM,FIXEDATOM,TORSION,DISTANCE,UPPER_WALLS,METAD,CENTER,PRINT,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
