...
**Publication:** [S. K. Ethirajan, A. R. Kulkarni, OPES-Enhanced Machine Learning Potentials Capture Node-Assisted Diffusion and Ring-Opening in SALEM-2 (2025)](http://dx.doi.org/10.26434/chemrxiv-2025-mg7qj)  
...
**Last tested:**  17 Jul 2025, 14:57:30
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,WHOLEMOLECULES,ENDPLUMED,PROJECTION_ON_AXIS,MOLINFO,DISTANCES,DISTANCE,OPES_METAD,CENTER,UNITS,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
