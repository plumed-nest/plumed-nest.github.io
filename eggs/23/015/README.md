...
**Last tested:**  11 Nov 2025, 09:59:06
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,METAD,COM,COORDINATION,LOWER_WALLS,CENTER,OPES_METAD_EXPLORE,CUSTOM,PRINT,DISTANCE,UPPER_WALLS,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
