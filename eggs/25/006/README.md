...
**Last tested:**  11 Nov 2025, 09:46:47
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,VOLUME,DUMPATOMS,READ,ENERGY,UPDATE_IF,INCLUDE,CENTER,MOLINFO,GYRATION,DISTANCE,PBMETAD,PRINT,RESTART,TORSION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
