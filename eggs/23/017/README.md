...
**Last tested:**  29 May 2025, 06:57:36
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPES_METAD_EXPLORE,FIT_TO_TEMPLATE,CUSTOM,CENTER,COORDINATION,PYTORCH_MODEL,WHOLEMOLECULES,PRINT,FIXEDATOM,GROUP,DISTANCE,LOWER_WALLS,OPES_METAD,UNITS,TORSION,PATH,UPPER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
