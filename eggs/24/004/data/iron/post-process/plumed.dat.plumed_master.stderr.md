...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.WOVYut.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.WOVYut.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.WOVYut.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.WOVYut.cpp: In static member function ‘static void PLMD::colvar::GraphGenerator::registerKeywords(PLMD::Keywords&)’:
Graph.WOVYut.cpp:103:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
Graph.WOVYut.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.WOVYut.cpp:82:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
82 |   bool serial,pbc;
|               ^~~
Graph.WOVYut.cpp:82:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
82 |   bool serial,pbc;
|        ^~~~~~
Graph.WOVYut.cpp:107:1: warning:   when initialized here [-Wreorder]
107 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.WOVYut.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.WOVYut.cpp:179:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.WOVYut.cpp:180:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
180 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.WOVYut.cpp:185:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
185 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.WOVYut.cpp:186:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
186 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.WOVYut.cpp:218:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
218 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.WOVYut.cpp:219:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.WOVYut.cpp:220:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[runnervmeorf1:07625] *** Process received signal ***
[runnervmeorf1:07625] Signal: Aborted (6)
[runnervmeorf1:07625] Signal code:  (-6)
[runnervmeorf1:07625] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fb724a45330]
[runnervmeorf1:07625] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fb724a9eb2c]
[runnervmeorf1:07625] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fb724a4527e]
[runnervmeorf1:07625] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fb724a288ff]
[runnervmeorf1:07625] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fb724ea5ff5]
[runnervmeorf1:07625] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fb724ebb0da]
[runnervmeorf1:07625] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fb724ea5a55]
[runnervmeorf1:07625] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fb724ea5a6f]
[runnervmeorf1:07625] [ 8] plumed_master(+0x146dd)[0x5562630b16dd]
[runnervmeorf1:07625] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fb724a2a1ca]
[runnervmeorf1:07625] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fb724a2a28b]
[runnervmeorf1:07625] [11] plumed_master(+0x15365)[0x5562630b2365]
[runnervmeorf1:07625] *** End of error message ***
</pre>
{% endraw %}
