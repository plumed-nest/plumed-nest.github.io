...
**Last tested:**  10 Mar 2026, 10:55:56
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DISTANCE,OPES_METAD,GROUP,ENERGY,TORSION,ENDPLUMED,COMMITTOR,PYTORCH_MODEL,MOLINFO,COMBINE,CUSTOM,MATHEVAL,WHOLEMOLECULES,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
