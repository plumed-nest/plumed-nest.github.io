...
**Last tested:**  15 Jan 2026, 17:01:25
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DUMPGRID,CLUSTER_NATOMS,DENSITY,RESTRAINT,UNITS,LOCAL_AVERAGE,HISTOGRAM,FIXEDATOM,GROUP,LOAD,PRINT,CLUSTER_DISTRIBUTION,CONTACT_MATRIX,AROUND,DFSCLUSTERING,LOCAL_Q3,Q3,COORDINATIONNUMBER" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
