...
**Last tested:**  15 Jan 2026, 17:03:29
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMMITTOR,INCLUDE,FIXEDATOM,PRINT,MATHEVAL,MOLINFO,COMBINE,ENERGY,OPES_METAD,RMSD,WHOLEMOLECULES,UPPER_WALLS,ANGLE,CENTER,FIT_TO_TEMPLATE,COORDINATION,DISTANCE,LOWER_WALLS,CONTACTMAP,CUSTOM,PYTORCH_MODEL,GROUP,ENDPLUMED" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
