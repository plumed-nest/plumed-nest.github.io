...
**Last tested:**  27 Jul 2026, 19:24:45
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PYTORCH_MODEL,UNITS,WHOLEMOLECULES,PATH,COORDINATION,OPES_METAD,LOWER_WALLS,CENTER,OPES_METAD_EXPLORE,FIT_TO_TEMPLATE,UPPER_WALLS,FIXEDATOM,CUSTOM,TORSION,GROUP,DISTANCE,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
