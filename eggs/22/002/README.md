...
**Last tested:**  15 May 2025, 08:23:21
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENDPLUMED,FIXEDATOM,COORDINATION,FIT_TO_TEMPLATE,PRINT,PYTORCH_MODEL,COMMITTOR,UPPER_WALLS,CENTER,MATHEVAL,FLUSH,ENERGY,ANGLE,DISTANCE,WHOLEMOLECULES,GROUP,LOAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
