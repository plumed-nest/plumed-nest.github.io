...
**Last tested:**  10 Mar 2026, 11:19:16
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=LOAD,COORDINATIONNUMBER,FIXEDATOM,RESTRAINT,DENSITY,CONTACT_MATRIX,GROUP,DFSCLUSTERING,CLUSTER_DISTRIBUTION,DUMPGRID,MFILTER_MORE,MULTICOLVARDENS,CLUSTER_NATOMS,PRINT,AROUND" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
