...
**Last tested:**  15 Jan 2026, 16:59:15
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=TORSION,PRINT,ENERGY,DISTANCE,MOLINFO,PBMETAD,WHOLEMOLECULES,CENTER,UPDATE_IF,VOLUME,INCLUDE,GYRATION,DUMPATOMS,RESTART,READ" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
