...
**Last tested:**  27 Jul 2026, 19:41:08
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=AROUND,LOCAL_AVERAGE,CLUSTER_NATOMS,RESTRAINT,PRINT,DFSCLUSTERING,Q3,CONTACT_MATRIX,CLUSTER_DISTRIBUTION,LOAD,COORDINATIONNUMBER,FIXEDATOM,UNITS,LOCAL_Q3,GROUP,DENSITY,DUMPGRID,HISTOGRAM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
