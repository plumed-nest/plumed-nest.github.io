...
**Last tested:**  15 Jan 2026, 17:03:41
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMBINE,TORSION,CUSTOM,PRINT,PYTORCH_MODEL,ENERGY,MOLINFO,MATHEVAL,WHOLEMOLECULES,GROUP,DISTANCE,OPES_METAD,ENDPLUMED,COMMITTOR" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
