...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MOVINGRESTRAINT,METAD,REWEIGHT_METAD,DUMPGRID,LOAD,HISTOGRAM,COMMITTOR,CONVERT_TO_FES,UNITS,COORDINATIONNUMBER,FLUSH,UPPER_WALLS,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
