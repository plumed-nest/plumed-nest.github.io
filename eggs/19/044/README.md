...
**Last tested:**  21 Jun 2025, 14:03:09
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMBINE,HISTOGRAM,CONVERT_TO_FES,AVERAGE,VOLUME,BF_LEGENDRE,VES_LINEAR_EXPANSION,DUMPGRID,RESTART,ENERGY,READ,TD_MULTITHERMAL_MULTIBARIC,REWEIGHT_BIAS,PRINT,OPT_DUMMY,REWEIGHT_TEMP_PRESS,OPT_AVERAGED_SGD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
