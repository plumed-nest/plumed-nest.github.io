...
**Last tested:**  22 Aug 2026, 14:51:58
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=BF_GAUSSIANS,BF_CUBIC_B_SPLINES,BF_CHEBYSHEV,COORDINATION,OPT_AVERAGED_SGD,FLUSH,PRINT,DISTANCE,TD_UNIFORM,POSITION,BF_WAVELETS,VES_OUTPUT_BASISFUNCTIONS,UPPER_WALLS,TD_WELLTEMPERED,VES_LINEAR_EXPANSION,BF_LEGENDRE,UNITS,ENERGY,INCLUDE,OPT_ADAM,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
