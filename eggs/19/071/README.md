...
**Last tested:**  03 Feb 2026, 21:14:14
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=HISTOGRAM,COMMITTOR,DISTANCE,READ,REWEIGHT_METAD,METAD,PRINT,REWEIGHT_BIAS,EXTERNAL,BIASVALUE,CONVERT_TO_FES,DUMPGRID,MATHEVAL,TORSION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
