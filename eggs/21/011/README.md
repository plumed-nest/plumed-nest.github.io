...
**Last tested:**  01 Sep 2026, 14:40:04
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,LOAD,MFILTER_MORE,CLUSTER_DISTRIBUTION,FIXEDATOM,COORDINATIONNUMBER,RESTRAINT,CONTACT_MATRIX,DFSCLUSTERING,DUMPGRID,MULTICOLVARDENS,AROUND,DENSITY,CLUSTER_NATOMS,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
