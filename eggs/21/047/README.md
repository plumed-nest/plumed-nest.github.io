...
**Last tested:**  21 Jun 2025, 13:47:01
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENERGY,OPT_AVERAGED_SGD,VOLUME,COMBINE,RESTART,LOAD,METAD,PRINT,BF_LEGENDRE,VES_LINEAR_EXPANSION,TD_WELLTEMPERED,PAIRENTROPY" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
