...
**Last tested:**  27 Jun 2025, 17:44:19
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,CENTER,UNITS,DISTANCE,BIASVALUE,OPES_METAD_EXPLORE,WHOLEMOLECULES,COORDINATION,GROUP,FIXEDATOM,ENDPLUMED,POSITION,ENERGY,METAD,COMBINE,PYTORCH_MODEL,PRINT,FLUSH,LOWER_WALLS,UPPER_WALLS,INCLUDE,CUSTOM,OPES_METAD,CONTACTMAP,MOLINFO,MATHEVAL,RMSD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
