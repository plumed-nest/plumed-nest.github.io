...
**Last tested:**  21 Jun 2025, 13:44:55
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,UNITS,MATHEVAL,OPES_METAD,LOWER_WALLS,FIT_TO_TEMPLATE,TORSION,WHOLEMOLECULES,ENDPLUMED,DISTANCES,LOAD,ANGLE,GROUP,DISTANCE,UPPER_WALLS,PRINT,CENTER,FIXEDATOM,PYTORCH_MODEL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
