...
**Last tested:**  03 Jul 2025, 13:21:06
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=BF_CUBIC_B_SPLINES,TD_WELLTEMPERED,POSITION,BF_CHEBYSHEV,OPT_ADAM,ENERGY,OPT_AVERAGED_SGD,UNITS,BF_WAVELETS,FLUSH,UPPER_WALLS,VES_LINEAR_EXPANSION,VES_OUTPUT_BASISFUNCTIONS,INCLUDE,TD_UNIFORM,COORDINATION,BF_GAUSSIANS,METAD,DISTANCE,PRINT,BF_LEGENDRE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
