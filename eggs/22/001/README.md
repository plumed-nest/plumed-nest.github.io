...
**Last tested:**  03 Feb 2026, 21:25:49
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=TD_WELLTEMPERED,BF_WAVELETS,FLUSH,BF_LEGENDRE,VES_LINEAR_EXPANSION,VES_OUTPUT_BASISFUNCTIONS,BF_CHEBYSHEV,OPT_AVERAGED_SGD,UNITS,TD_UNIFORM,UPPER_WALLS,POSITION,BF_CUBIC_B_SPLINES,ENERGY,BF_GAUSSIANS,PRINT,DISTANCE,COORDINATION,INCLUDE,OPT_ADAM,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
