...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.upuHBE.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.upuHBE.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.upuHBE.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.upuHBE.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.upuHBE.cpp:82:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
82 |   bool serial,pbc;
|               ^~~
Graph.upuHBE.cpp:82:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
82 |   bool serial,pbc;
|        ^~~~~~
Graph.upuHBE.cpp:107:1: warning:   when initialized here [-Wreorder]
107 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.upuHBE.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.upuHBE.cpp:179:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.upuHBE.cpp:180:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
180 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.upuHBE.cpp:185:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
185 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.upuHBE.cpp:186:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
186 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.upuHBE.cpp:189:3: error: ‘Matrix’ was not declared in this scope
189 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.upuHBE.cpp:189:10: error: expected primary-expression before ‘double’
189 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.upuHBE.cpp:190:10: error: expected primary-expression before ‘double’
190 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.upuHBE.cpp:191:16: error: expected primary-expression before ‘>’ token
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.upuHBE.cpp:191:18: error: ‘dist_deriv_mat’ was not declared in this scope
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.upuHBE.cpp:211:11: error: ‘dist_mat’ was not declared in this scope
211 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.upuHBE.cpp:212:11: error: ‘idxn_mat’ was not declared in this scope
212 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.upuHBE.cpp:218:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
218 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.upuHBE.cpp:218:18: error: ‘dist_mat’ was not declared in this scope
218 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.upuHBE.cpp:219:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.upuHBE.cpp:219:18: error: ‘idxn_mat’ was not declared in this scope
219 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.upuHBE.cpp:220:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
220 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.upuHBE.cpp:224:25: error: ‘dist_mat’ was not declared in this scope
224 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.upuHBE.cpp:225:25: error: ‘idxn_mat’ was not declared in this scope
...
[fv-az2035-366:05683] *** Process received signal ***
[fv-az2035-366:05683] Signal: Aborted (6)
[fv-az2035-366:05683] Signal code:  (-6)
[fv-az2035-366:05683] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fe108645330]
[fv-az2035-366:05683] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fe10869eb2c]
[fv-az2035-366:05683] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fe10864527e]
[fv-az2035-366:05683] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fe1086288ff]
[fv-az2035-366:05683] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fe108aa5ff5]
[fv-az2035-366:05683] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fe108abb0da]
[fv-az2035-366:05683] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fe108aa5a55]
[fv-az2035-366:05683] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fe108aa5a6f]
[fv-az2035-366:05683] [ 8] plumed(+0x146dd)[0x56117ea276dd]
[fv-az2035-366:05683] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fe10862a1ca]
[fv-az2035-366:05683] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fe10862a28b]
[fv-az2035-366:05683] [11] plumed(+0x15365)[0x56117ea28365]
[fv-az2035-366:05683] *** End of error message ***
</pre>
{% endraw %}
