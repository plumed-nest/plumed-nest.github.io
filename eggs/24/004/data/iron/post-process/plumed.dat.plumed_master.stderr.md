...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.xZWF0W.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.xZWF0W.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.xZWF0W.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.xZWF0W.cpp: In static member function ‘static void PLMD::colvar::GraphGenerator::registerKeywords(PLMD::Keywords&)’:
Graph.xZWF0W.cpp:103:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
Graph.xZWF0W.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.xZWF0W.cpp:82:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
82 |   bool serial,pbc;
|               ^~~
Graph.xZWF0W.cpp:82:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
82 |   bool serial,pbc;
|        ^~~~~~
Graph.xZWF0W.cpp:107:1: warning:   when initialized here [-Wreorder]
107 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.xZWF0W.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.xZWF0W.cpp:179:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.xZWF0W.cpp:180:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
180 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xZWF0W.cpp:185:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
185 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xZWF0W.cpp:186:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
186 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xZWF0W.cpp:218:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
218 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xZWF0W.cpp:219:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xZWF0W.cpp:220:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[runnervm76f27:07130] *** Process received signal ***
[runnervm76f27:07130] Signal: Aborted (6)
[runnervm76f27:07130] Signal code:  (-6)
[runnervm76f27:07130] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7faf1e245330]
[runnervm76f27:07130] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7faf1e29ec0c]
[runnervm76f27:07130] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7faf1e24527e]
[runnervm76f27:07130] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7faf1e2288ff]
[runnervm76f27:07130] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7faf1e6a5ff5]
[runnervm76f27:07130] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7faf1e6bb0da]
[runnervm76f27:07130] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7faf1e6a5a55]
[runnervm76f27:07130] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7faf1e6a5a6f]
[runnervm76f27:07130] [ 8] plumed_master(+0x146dd)[0x5650e249a6dd]
[runnervm76f27:07130] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7faf1e22a1ca]
[runnervm76f27:07130] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7faf1e22a28b]
[runnervm76f27:07130] [11] plumed_master(+0x15365)[0x5650e249b365]
[runnervm76f27:07130] *** End of error message ***
</pre>
{% endraw %}
