...
**Last tested:**  22 May 2025, 18:23:56
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DENSITY,GROUP,CONTACT_MATRIX,LOAD,PRINT,DUMPGRID,MFILTER_MORE,AROUND,COORDINATIONNUMBER,CLUSTER_DISTRIBUTION,CLUSTER_NATOMS,RESTRAINT,DFSCLUSTERING,MULTICOLVARDENS,FIXEDATOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
