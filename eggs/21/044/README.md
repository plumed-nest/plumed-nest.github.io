...
**Last tested:**  17 Jul 2025, 15:18:51
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CLUSTER_NATOMS,GROUP,LOCAL_Q6,MFILTER_MORE,DFSCLUSTERING,DUMPGRID,FIXEDATOM,CONTACT_MATRIX,Q6,HISTOGRAM,PRINT,CLUSTER_DISTRIBUTION,METAD,INSPHERE,COMBINE,COORDINATIONNUMBER" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
