...
**Last tested:**  03 Jul 2025, 13:16:50
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,PRINT,UPPER_WALLS,DISTANCE,COORDINATION,FIT_TO_TEMPLATE,WHOLEMOLECULES,TORSION,PATH,LOWER_WALLS,OPES_METAD_EXPLORE,PYTORCH_MODEL,CENTER,FIXEDATOM,OPES_METAD,UNITS,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
