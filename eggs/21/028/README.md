...
**Last tested:**  27 Jun 2025, 18:00:58
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,WHOLEMOLECULES,PYTORCH_MODEL,LOAD,ANGLE,ENDPLUMED,PRINT,UNITS,MATHEVAL,DISTANCES,LOWER_WALLS,TORSION,DISTANCE,FIXEDATOM,UPPER_WALLS,CENTER,COORDINATION,OPES_METAD,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
