...
**Last tested:**  01 Sep 2026, 14:28:17
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,GROUP,UNITS,CLUSTER_NATOMS,LOAD,DUMPGRID,RESTRAINT,LOCAL_AVERAGE,DENSITY,COORDINATIONNUMBER,DFSCLUSTERING,HISTOGRAM,PRINT,AROUND,CONTACT_MATRIX,CLUSTER_DISTRIBUTION,LOCAL_Q3,Q3" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
