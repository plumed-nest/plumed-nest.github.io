...
**Last tested:**  03 Feb 2026, 21:15:58
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CUSTOM,FIXEDATOM,FIT_TO_TEMPLATE,COMMITTOR,COORDINATION,RMSD,PYTORCH_MODEL,GROUP,OPES_METAD,CENTER,DISTANCE,UPPER_WALLS,WHOLEMOLECULES,LOWER_WALLS,PRINT,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
