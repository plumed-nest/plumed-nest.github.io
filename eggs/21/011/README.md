...
**Last tested:**  03 Feb 2026, 21:17:48
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,AROUND,RESTRAINT,COORDINATIONNUMBER,MULTICOLVARDENS,CLUSTER_NATOMS,LOAD,DUMPGRID,MFILTER_MORE,PRINT,FIXEDATOM,DFSCLUSTERING,CLUSTER_DISTRIBUTION,DENSITY,CONTACT_MATRIX" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
