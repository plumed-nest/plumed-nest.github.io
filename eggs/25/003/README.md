...
**Last tested:**  29 May 2025, 06:50:19
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,PYTORCH_MODEL,GROUP,ENERGY,TORSION,COMMITTOR,DISTANCE,OPES_METAD,PRINT,COMBINE,MOLINFO,CUSTOM,ENDPLUMED,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
