...
**Last tested:**  03 Feb 2026, 21:25:44
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UNITS,LOAD,PYTORCH_MODEL,LOWER_WALLS,WHOLEMOLECULES,FIT_TO_TEMPLATE,OPES_METAD,PRINT,MATHEVAL,CENTER,ENDPLUMED,TORSION,GROUP,UPPER_WALLS,COORDINATION,FIXEDATOM,DISTANCES,DISTANCE,ANGLE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
