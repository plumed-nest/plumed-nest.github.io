...
**Last tested:**  25 Jul 2025, 11:38:07
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DUMPGRID,CLUSTER_DISTRIBUTION,LOCAL_AVERAGE,LOAD,RESTRAINT,Q3,FIXEDATOM,DFSCLUSTERING,CONTACT_MATRIX,UNITS,PRINT,GROUP,DENSITY,AROUND,COORDINATIONNUMBER,CLUSTER_NATOMS,LOCAL_Q3,HISTOGRAM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
