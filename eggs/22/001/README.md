...
**Last tested:**  11 Nov 2025, 10:03:37
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=VES_OUTPUT_BASISFUNCTIONS,OPT_ADAM,BF_WAVELETS,UPPER_WALLS,INCLUDE,TD_WELLTEMPERED,PRINT,BF_LEGENDRE,BF_GAUSSIANS,UNITS,FLUSH,TD_UNIFORM,ENERGY,POSITION,VES_LINEAR_EXPANSION,DISTANCE,BF_CUBIC_B_SPLINES,COORDINATION,OPT_AVERAGED_SGD,METAD,BF_CHEBYSHEV" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
