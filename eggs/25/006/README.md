...
**Last tested:**  29 Jun 2026, 10:08:31
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=READ,UPDATE_IF,ENERGY,DISTANCE,PRINT,WHOLEMOLECULES,PBMETAD,VOLUME,CENTER,DUMPATOMS,GYRATION,INCLUDE,TORSION,MOLINFO,RESTART" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
