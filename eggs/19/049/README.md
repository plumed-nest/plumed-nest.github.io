...
**Last tested:**  15 Jan 2026, 17:22:30
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,CLUSTER_NATOMS,CLUSTER_PROPERTIES,OUTPUT_CLUSTER,DISTANCES,DFSCLUSTERING,MORE_THAN,Q6,COORDINATIONNUMBER,CUSTOM,CLUSTER_DISTRIBUTION,LOCAL_Q6,METAD,CONTACT_MATRIX,SMAC,ONES,OUTER_PRODUCT,MATRIX_VECTOR_PRODUCT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
