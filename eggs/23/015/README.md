...
**Last tested:**  15 Jan 2026, 17:12:18
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPES_METAD_EXPLORE,PRINT,METAD,CENTER,CUSTOM,GROUP,LOWER_WALLS,COM,COORDINATION,WHOLEMOLECULES,UPPER_WALLS,DISTANCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
