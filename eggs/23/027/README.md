...
**Last tested:**  17 Jul 2025, 15:06:53
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=AROUND,DUMPGRID,CLUSTER_DISTRIBUTION,PRINT,Q3,LOCAL_Q3,CONTACT_MATRIX,RESTRAINT,LOAD,FIXEDATOM,DENSITY,HISTOGRAM,DFSCLUSTERING,CLUSTER_NATOMS,GROUP,COORDINATIONNUMBER,UNITS,LOCAL_AVERAGE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
