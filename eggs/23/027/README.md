...
**Last tested:**  20 Apr 2026, 09:24:50
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,UNITS,Q3,PRINT,COORDINATIONNUMBER,CLUSTER_NATOMS,LOCAL_AVERAGE,AROUND,LOAD,FIXEDATOM,RESTRAINT,HISTOGRAM,DFSCLUSTERING,CONTACT_MATRIX,DENSITY,LOCAL_Q3,DUMPGRID,CLUSTER_DISTRIBUTION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
