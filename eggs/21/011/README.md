...
**Last tested:**  29 Jun 2026, 10:31:52
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CONTACT_MATRIX,DENSITY,LOAD,DUMPGRID,DFSCLUSTERING,FIXEDATOM,RESTRAINT,MULTICOLVARDENS,CLUSTER_DISTRIBUTION,MFILTER_MORE,GROUP,AROUND,COORDINATIONNUMBER,CLUSTER_NATOMS,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
