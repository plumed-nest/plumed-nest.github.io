...
**Last tested:**  10 Mar 2026, 11:13:03
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GYRATION,INCLUDE,COM,DUMPGRID,REWEIGHT_BIAS,CONVERT_TO_FES,PRINT,DISTANCES,GROUP,COMBINE,HISTOGRAM,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
