...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.TmuwX3.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.TmuwX3.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.TmuwX3.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.TmuwX3.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.TmuwX3.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.TmuwX3.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.TmuwX3.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.TmuwX3.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.TmuwX3.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.TmuwX3.cpp:197:3: error: ‘Matrix’ was not declared in this scope
197 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.TmuwX3.cpp:197:10: error: expected primary-expression before ‘double’
197 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.TmuwX3.cpp:198:16: error: expected primary-expression before ‘>’ token
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.TmuwX3.cpp:198:18: error: ‘dist_deriv_mat’ was not declared in this scope
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.TmuwX3.cpp:213:7: error: ‘dist_mat’ was not declared in this scope
213 |       dist_mat[i][j] = value;
|       ^~~~~~~~
Graph.TmuwX3.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
Graph.TmuwX3.cpp:232:19: error: ‘dist_mat’ was not declared in this scope
...
[pkrvmpptgkbjq6m:06668] *** Process received signal ***
[pkrvmpptgkbjq6m:06668] Signal: Aborted (6)
[pkrvmpptgkbjq6m:06668] Signal code:  (-6)
[pkrvmpptgkbjq6m:06668] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f4351445330]
[pkrvmpptgkbjq6m:06668] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f435149eb2c]
[pkrvmpptgkbjq6m:06668] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f435144527e]
[pkrvmpptgkbjq6m:06668] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f43514288ff]
[pkrvmpptgkbjq6m:06668] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f43518a5ff5]
[pkrvmpptgkbjq6m:06668] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f43518bb0da]
[pkrvmpptgkbjq6m:06668] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f43518a5a55]
[pkrvmpptgkbjq6m:06668] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f43518a5a6f]
[pkrvmpptgkbjq6m:06668] [ 8] plumed(+0x146dd)[0x562f4f3866dd]
[pkrvmpptgkbjq6m:06668] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f435142a1ca]
[pkrvmpptgkbjq6m:06668] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f435142a28b]
[pkrvmpptgkbjq6m:06668] [11] plumed(+0x15365)[0x562f4f387365]
[pkrvmpptgkbjq6m:06668] *** End of error message ***
</pre>
{% endraw %}
