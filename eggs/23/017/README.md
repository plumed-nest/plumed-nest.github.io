...
**Last tested:**  11 Nov 2025, 09:53:26
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,DISTANCE,PRINT,OPES_METAD_EXPLORE,UPPER_WALLS,GROUP,TORSION,PATH,CUSTOM,PYTORCH_MODEL,UNITS,LOWER_WALLS,COORDINATION,FIT_TO_TEMPLATE,OPES_METAD,WHOLEMOLECULES,CENTER" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
