...
**Last tested:**  15 May 2025, 08:21:44
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DUMPGRID,DENSITY,AROUND,DFSCLUSTERING,Q3,HISTOGRAM,LOAD,CONTACT_MATRIX,UNITS,RESTRAINT,CLUSTER_DISTRIBUTION,COORDINATIONNUMBER,FIXEDATOM,LOCAL_Q3,CLUSTER_NATOMS,GROUP,PRINT,LOCAL_AVERAGE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
