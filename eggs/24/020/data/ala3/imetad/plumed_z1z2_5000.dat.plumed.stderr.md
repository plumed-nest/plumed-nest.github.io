...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.2qPzHt.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.2qPzHt.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.2qPzHt.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.2qPzHt.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.2qPzHt.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.2qPzHt.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.2qPzHt.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.2qPzHt.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.2qPzHt.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.2qPzHt.cpp:197:3: error: ‘Matrix’ was not declared in this scope
197 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.2qPzHt.cpp:197:10: error: expected primary-expression before ‘double’
197 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.2qPzHt.cpp:198:16: error: expected primary-expression before ‘>’ token
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.2qPzHt.cpp:198:18: error: ‘dist_deriv_mat’ was not declared in this scope
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.2qPzHt.cpp:213:7: error: ‘dist_mat’ was not declared in this scope
213 |       dist_mat[i][j] = value;
|       ^~~~~~~~
Graph.2qPzHt.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
Graph.2qPzHt.cpp:232:19: error: ‘dist_mat’ was not declared in this scope
...
[pkrvmq0rgcvqdmg:07438] *** Process received signal ***
[pkrvmq0rgcvqdmg:07438] Signal: Aborted (6)
[pkrvmq0rgcvqdmg:07438] Signal code:  (-6)
[pkrvmq0rgcvqdmg:07438] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f2fd4845330]
[pkrvmq0rgcvqdmg:07438] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f2fd489eb2c]
[pkrvmq0rgcvqdmg:07438] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f2fd484527e]
[pkrvmq0rgcvqdmg:07438] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f2fd48288ff]
[pkrvmq0rgcvqdmg:07438] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f2fd4ca5ff5]
[pkrvmq0rgcvqdmg:07438] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f2fd4cbb0da]
[pkrvmq0rgcvqdmg:07438] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f2fd4ca5a55]
[pkrvmq0rgcvqdmg:07438] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f2fd4ca5a6f]
[pkrvmq0rgcvqdmg:07438] [ 8] plumed(+0x146dd)[0x5603c080c6dd]
[pkrvmq0rgcvqdmg:07438] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f2fd482a1ca]
[pkrvmq0rgcvqdmg:07438] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f2fd482a28b]
[pkrvmq0rgcvqdmg:07438] [11] plumed(+0x15365)[0x5603c080d365]
[pkrvmq0rgcvqdmg:07438] *** End of error message ***
</pre>
{% endraw %}
