...
**Last tested:**  22 May 2025, 18:09:09
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,UNITS,PYTORCH_MODEL,GROUP,TORSION,PRINT,LOWER_WALLS,OPES_METAD_EXPLORE,CENTER,FIT_TO_TEMPLATE,FIXEDATOM,WHOLEMOLECULES,DISTANCE,PATH,CUSTOM,UPPER_WALLS,OPES_METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
