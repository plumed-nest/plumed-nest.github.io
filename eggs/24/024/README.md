...
**Last tested:**  15 Jan 2026, 17:02:55
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CENTER,FIXEDATOM,PRINT,ENERGY,ENDPLUMED,OPES_METAD_EXPLORE,ANGLE,OPES_EXPANDED,FIT_TO_TEMPLATE,WHOLEMOLECULES,MATHEVAL,GROUP,COORDINATION,ECV_MULTITHERMAL,UPPER_WALLS,TORSION,DISTANCE,LOWER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
