...
**Last tested:**  10 Mar 2026, 11:04:49
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DENSITY,LOAD,HISTOGRAM,Q3,LOCAL_AVERAGE,CLUSTER_NATOMS,LOCAL_Q3,CONTACT_MATRIX,GROUP,PRINT,DFSCLUSTERING,COORDINATIONNUMBER,RESTRAINT,FIXEDATOM,UNITS,CLUSTER_DISTRIBUTION,AROUND,DUMPGRID" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
