...
**Last tested:**  29 Jun 2026, 10:28:32
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MATHEVAL,TORSION,ANGLE,ENERGY,GROUP,ENDPLUMED,OPES_EXPANDED,PRINT,WHOLEMOLECULES,ECV_MULTITHERMAL,UPPER_WALLS,FIT_TO_TEMPLATE,DISTANCE,OPES_METAD_EXPLORE,COORDINATION,CENTER,LOWER_WALLS,FIXEDATOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
