...
**Last tested:**  27 Jul 2026, 19:18:09
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENERGY,OPES_EXPANDED,GROUP,ECV_MULTITHERMAL,COORDINATION,RMSD,MOLINFO,COMBINE,CENTER,GHOST,OPES_METAD_EXPLORE,DISTANCE,CUSTOM,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
