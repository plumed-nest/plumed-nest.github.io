...
from GraphMolNoDeriv.ovbR8l.cpp:32:
...
from GraphMolNoDeriv.ovbR8l.cpp:26:
...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
GraphMolNoDeriv.ovbR8l.cpp:45:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
GraphMolNoDeriv.ovbR8l.cpp:45:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
45 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
GraphMolNoDeriv.ovbR8l.cpp: In member function ‘virtual void PLMD::colvar::MolecularGraphGenerator::calculate()’:
GraphMolNoDeriv.ovbR8l.cpp:218:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:219:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:224:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
224 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:225:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
225 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:228:3: error: ‘Matrix’ was not declared in this scope
228 |   Matrix<double> idxn_mat(_n_node, kcut);
|   ^~~~~~
GraphMolNoDeriv.ovbR8l.cpp:228:10: error: expected primary-expression before ‘double’
228 |   Matrix<double> idxn_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.ovbR8l.cpp:229:10: error: expected primary-expression before ‘double’
229 |   Matrix<double> theta1_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.ovbR8l.cpp:230:10: error: expected primary-expression before ‘double’
230 |   Matrix<double> theta2_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.ovbR8l.cpp:231:10: error: expected primary-expression before ‘double’
231 |   Matrix<double> theta3_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.ovbR8l.cpp:232:10: error: expected primary-expression before ‘double’
232 |   Matrix<double> theta4_mat(_n_node, kcut);
|          ^~~~~~
GraphMolNoDeriv.ovbR8l.cpp:233:16: error: expected primary-expression before ‘>’ token
233 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.ovbR8l.cpp:233:18: error: ‘theta1_deriv_mat’ was not declared in this scope
233 |   Matrix<Vector> theta1_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:234:16: error: expected primary-expression before ‘>’ token
234 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.ovbR8l.cpp:234:18: error: ‘theta2_deriv_mat’ was not declared in this scope
234 |   Matrix<Vector> theta2_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:235:16: error: expected primary-expression before ‘>’ token
235 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.ovbR8l.cpp:235:18: error: ‘theta3_deriv_mat’ was not declared in this scope
235 |   Matrix<Vector> theta3_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:236:16: error: expected primary-expression before ‘>’ token
236 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                ^
GraphMolNoDeriv.ovbR8l.cpp:236:18: error: ‘theta4_deriv_mat’ was not declared in this scope
236 |   Matrix<Vector> theta4_deriv_mat(_n_node, 2*kcut);
|                  ^~~~~~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:283:11: error: ‘idxn_mat’ was not declared in this scope
283 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:309:11: error: ‘theta1_mat’ was not declared in this scope; did you mean ‘theta1’?
309 |           theta1_mat[i][k-1] += theta1;
|           ^~~~~~~~~~
|           theta1
GraphMolNoDeriv.ovbR8l.cpp:310:11: error: ‘theta2_mat’ was not declared in this scope; did you mean ‘theta2’?
310 |           theta2_mat[i][k-1] += theta2;
|           ^~~~~~~~~~
|           theta2
GraphMolNoDeriv.ovbR8l.cpp:311:11: error: ‘theta3_mat’ was not declared in this scope; did you mean ‘theta3’?
311 |           theta3_mat[i][k-1] += theta3;
|           ^~~~~~~~~~
|           theta3
GraphMolNoDeriv.ovbR8l.cpp:312:11: error: ‘theta4_mat’ was not declared in this scope; did you mean ‘theta4’?
312 |           theta4_mat[i][k-1] += theta4;
|           ^~~~~~~~~~
|           theta4
GraphMolNoDeriv.ovbR8l.cpp:327:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
327 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:327:18: error: ‘idxn_mat’ was not declared in this scope
327 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:328:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
328 |         comm.Sum(theta1_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:328:18: error: ‘theta1_mat’ was not declared in this scope
328 |         comm.Sum(theta1_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:329:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
329 |         comm.Sum(theta2_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:329:18: error: ‘theta2_mat’ was not declared in this scope
329 |         comm.Sum(theta2_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:330:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
330 |         comm.Sum(theta3_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:330:18: error: ‘theta3_mat’ was not declared in this scope
330 |         comm.Sum(theta3_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:331:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
331 |         comm.Sum(theta4_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:331:18: error: ‘theta4_mat’ was not declared in this scope
331 |         comm.Sum(theta4_mat);
|                  ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:332:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
332 |         comm.Sum(theta1_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:333:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
333 |         comm.Sum(theta2_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:334:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
334 |         comm.Sum(theta3_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:335:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
335 |         comm.Sum(theta4_deriv_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:340:26: error: ‘theta1_mat’ was not declared in this scope
340 |   vector<double> input12=theta1_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:341:26: error: ‘theta2_mat’ was not declared in this scope
341 |   vector<double> input13=theta2_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:342:26: error: ‘theta3_mat’ was not declared in this scope
342 |   vector<double> input14=theta3_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:343:26: error: ‘theta4_mat’ was not declared in this scope
343 |   vector<double> input15=theta4_mat.getVector();
|                          ^~~~~~~~~~
GraphMolNoDeriv.ovbR8l.cpp:344:25: error: ‘idxn_mat’ was not declared in this scope
...
[pkrvm7jw40e0xgp:09006] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fe863645330]
[pkrvm7jw40e0xgp:09006] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fe86369eb2c]
[pkrvm7jw40e0xgp:09006] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fe86364527e]
[pkrvm7jw40e0xgp:09006] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fe8636288ff]
[pkrvm7jw40e0xgp:09006] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fe863aa5ff5]
[pkrvm7jw40e0xgp:09006] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fe863abb0da]
[pkrvm7jw40e0xgp:09006] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fe863aa5a55]
[pkrvm7jw40e0xgp:09006] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fe863aa5a6f]
[pkrvm7jw40e0xgp:09006] [ 8] plumed(+0x146dd)[0x5557705556dd]
[pkrvm7jw40e0xgp:09006] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fe86362a1ca]
[pkrvm7jw40e0xgp:09006] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fe86362a28b]
[pkrvm7jw40e0xgp:09006] [11] plumed(+0x15365)[0x555770556365]
