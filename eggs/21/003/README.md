...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,FLUSH,SAXS,PBMETAD,WHOLEMOLECULES,EEFSOLV,PRINT,CENTER,ALPHARMSD,GYRATION,METAINFERENCE,BIASVALUE,MOLINFO" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
