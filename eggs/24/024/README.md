...
**Last tested:**  03 Feb 2026, 21:13:33
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENERGY,CENTER,TORSION,PRINT,ENDPLUMED,ANGLE,DISTANCE,UPPER_WALLS,WHOLEMOLECULES,LOWER_WALLS,ECV_MULTITHERMAL,FIXEDATOM,COORDINATION,OPES_EXPANDED,FIT_TO_TEMPLATE,GROUP,MATHEVAL,OPES_METAD_EXPLORE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
