...
**Last tested:**  20 Apr 2026, 09:36:34
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMBINE,ENERGY,ANGLE,GROUP,OPES_METAD,CUSTOM,RMSD,MATHEVAL,UPPER_WALLS,COMMITTOR,LOWER_WALLS,FIXEDATOM,MOLINFO,CONTACTMAP,DISTANCE,WHOLEMOLECULES,PRINT,ENDPLUMED,INCLUDE,CENTER,PYTORCH_MODEL,FIT_TO_TEMPLATE,COORDINATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
