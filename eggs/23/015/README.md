...
**Last tested:**  03 Jul 2025, 13:09:35
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UPPER_WALLS,LOWER_WALLS,CUSTOM,COORDINATION,OPES_METAD_EXPLORE,PRINT,COM,CENTER,METAD,DISTANCE,WHOLEMOLECULES,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
