...
| [OAMe_G4/plumed.dat](./data/OAMe_G4/plumed.dat.md) |  [![tested on v2.10](https://img.shields.io/badge/v2.10-failed-red.svg)](data/OAMe_G4/plumed.dat.plumed.stderr) [![tested on master](https://img.shields.io/badge/master-passing-green.svg)](data/OAMe_G4/plumed.dat.plumed_master.stderr) |  
...
**Last tested:**  15 Jan 2026, 17:24:31
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,MATHEVAL,FIXEDATOM,DISTANCE,WHOLEMOLECULES,GROUP,PRINT,OPES_METAD,PYTORCH_MODEL,ANGLE,UPPER_WALLS,ENDPLUMED,ENERGY,COORDINATION,CENTER" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
