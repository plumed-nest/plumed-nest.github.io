...
**Last tested:**  03 Jul 2025, 13:13:34
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATIONNUMBER,HISTOGRAM,CLUSTER_NATOMS,LOCAL_AVERAGE,PRINT,GROUP,AROUND,Q3,DUMPGRID,DENSITY,FIXEDATOM,DFSCLUSTERING,CLUSTER_DISTRIBUTION,LOAD,RESTRAINT,UNITS,LOCAL_Q3,CONTACT_MATRIX" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
