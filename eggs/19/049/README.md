...
**Last tested:**  27 Jun 2025, 18:09:50
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MATRIX_VECTOR_PRODUCT,COORDINATIONNUMBER,OUTPUT_CLUSTER,ONES,CUSTOM,OUTER_PRODUCT,CLUSTER_PROPERTIES,LOCAL_Q6,MORE_THAN,Q6,CLUSTER_NATOMS,DFSCLUSTERING,PRINT,CONTACT_MATRIX,SMAC,CLUSTER_DISTRIBUTION,DISTANCES,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
