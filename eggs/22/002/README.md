...
**Last tested:**  15 Jan 2026, 17:15:19
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,COORDINATION,PRINT,FIT_TO_TEMPLATE,UPPER_WALLS,LOAD,CENTER,PYTORCH_MODEL,MATHEVAL,ENERGY,WHOLEMOLECULES,FLUSH,GROUP,DISTANCE,COMMITTOR,ENDPLUMED,ANGLE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
