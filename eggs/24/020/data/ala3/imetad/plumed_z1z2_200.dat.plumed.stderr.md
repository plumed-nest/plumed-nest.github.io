...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.EEHyju.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.EEHyju.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.EEHyju.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.EEHyju.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.EEHyju.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.EEHyju.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.EEHyju.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.EEHyju.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.EEHyju.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.EEHyju.cpp:197:3: error: ‘Matrix’ was not declared in this scope
197 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.EEHyju.cpp:197:10: error: expected primary-expression before ‘double’
197 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.EEHyju.cpp:198:16: error: expected primary-expression before ‘>’ token
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.EEHyju.cpp:198:18: error: ‘dist_deriv_mat’ was not declared in this scope
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.EEHyju.cpp:213:7: error: ‘dist_mat’ was not declared in this scope
213 |       dist_mat[i][j] = value;
|       ^~~~~~~~
Graph.EEHyju.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
Graph.EEHyju.cpp:232:19: error: ‘dist_mat’ was not declared in this scope
...
[pkrvmf6wy0o8zjz:34609] *** Process received signal ***
[pkrvmf6wy0o8zjz:34609] Signal: Aborted (6)
[pkrvmf6wy0o8zjz:34609] Signal code:  (-6)
[pkrvmf6wy0o8zjz:34609] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fb00f845330]
[pkrvmf6wy0o8zjz:34609] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fb00f89eb2c]
[pkrvmf6wy0o8zjz:34609] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fb00f84527e]
[pkrvmf6wy0o8zjz:34609] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fb00f8288ff]
[pkrvmf6wy0o8zjz:34609] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fb00fca5ff5]
[pkrvmf6wy0o8zjz:34609] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fb00fcbb0da]
[pkrvmf6wy0o8zjz:34609] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fb00fca5a55]
[pkrvmf6wy0o8zjz:34609] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fb00fca5a6f]
[pkrvmf6wy0o8zjz:34609] [ 8] plumed(+0x146dd)[0x564196c586dd]
[pkrvmf6wy0o8zjz:34609] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fb00f82a1ca]
[pkrvmf6wy0o8zjz:34609] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fb00f82a28b]
[pkrvmf6wy0o8zjz:34609] [11] plumed(+0x15365)[0x564196c59365]
[pkrvmf6wy0o8zjz:34609] *** End of error message ***
</pre>
{% endraw %}
