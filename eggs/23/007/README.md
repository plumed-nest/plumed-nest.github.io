...
**Last tested:**  15 Jan 2026, 17:07:54
  
**Project description and instructions**  
PLUMED files contain everything needed to reproduce parallel bias metadynamics on 2,3,4-mer helical peptoids.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PBMETAD,COORDINATION,TORSION,INCLUDE,PRINT,COM,WHOLEMOLECULES,GYRATION,RESTRAINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
