...
**Last tested:**  11 Nov 2025, 09:46:09
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MOLINFO,ENDPLUMED,DISTANCE,OPES_METAD,PYTORCH_MODEL,COMBINE,PRINT,WHOLEMOLECULES,ENERGY,COMMITTOR,GROUP,CUSTOM,TORSION,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
