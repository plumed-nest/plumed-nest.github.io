...
**Last tested:**  25 Jul 2025, 11:59:33
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,GROUP,INCLUDE,PBMETAD,COORDINATION,GYRATION,ALPHABETA,MOLINFO,METAINFERENCE,PRINT,CS2BACKBONE,CENTER,DISTANCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
