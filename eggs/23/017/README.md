...
**Last tested:**  22 Aug 2026, 14:40:31
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UNITS,FIT_TO_TEMPLATE,WHOLEMOLECULES,FIXEDATOM,PATH,OPES_METAD_EXPLORE,PRINT,GROUP,TORSION,LOWER_WALLS,OPES_METAD,CUSTOM,UPPER_WALLS,CENTER,COORDINATION,PYTORCH_MODEL,DISTANCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
