...
**Stable:** [raw zipped stdout](metad_35ang_sphere.dat.plumed.stdout.txt.zip) - [stderr](metad_35ang_sphere.dat.plumed.stderr)  
**Master:** [raw zipped stdout](metad_35ang_sphere.dat.plumed_master.stdout.txt.zip) - [stderr](metad_35ang_sphere.dat.plumed_master.stderr)  

{% raw %}<pre>
<a href="https://plumed.github.io/doc-master/user-doc/html/_w_h_o_l_e_m_o_l_e_c_u_l_e_s.html">WHOLEMOLECULES</a> ENTITY0=1-3677 ENTITY1=3678-3734

<span style="color:blue"># Group definition</span>
prot_noh: <a href="https://plumed.github.io/doc-master/user-doc/html/_g_r_o_u_p.html">GROUP</a> NDX_FILE=../input/MacroD2_sphere_input/ref_index.ndx NDX_GROUP=Protein-H
ref: <a href="https://plumed.github.io/doc-master/user-doc/html/_g_r_o_u_p.html">GROUP</a> NDX_FILE=../input/MacroD2_sphere_input/ref_index.ndx NDX_GROUP=Prot_ref_noH
AR6: <a href="https://plumed.github.io/doc-master/user-doc/html/_g_r_o_u_p.html">GROUP</a> NDX_FILE=../input/MacroD2_sphere_input/ref_index.ndx NDX_GROUP=AR6_noH 
...
rel_x: <a href="https://plumed.github.io/doc-master/user-doc/html/_m_a_t_h_e_v_a_l.html">MATHEVAL</a> ARG=abs_z,abs_y FUNC=(x-y)/sqrt(2) PERIODIC=NO
rel_y: <a href="https://plumed.github.io/doc-master/user-doc/html/_m_a_t_h_e_v_a_l.html">MATHEVAL</a> ARG=abs_x FUNC=x PERIODIC=NO
rel_z: <a href="https://plumed.github.io/doc-master/user-doc/html/_m_a_t_h_e_v_a_l.html">MATHEVAL</a> ARG=abs_z,abs_y FUNC=(x+y)/sqrt(2) PERIODIC=NO
...
theta: <a href="https://plumed.github.io/doc-master/user-doc/html/_m_a_t_h_e_v_a_l.html">MATHEVAL</a> ARG=rel_z,rho FUNC=acos(x/y) PERIODIC=0,pi
phi: <a href="https://plumed.github.io/doc-master/user-doc/html/_m_a_t_h_e_v_a_l.html">MATHEVAL</a> ARG=rel_x,rel_y FUNC=atan2(y,x) PERIODIC=-pi,pi

rmsd: <a href="https://plumed.github.io/doc-master/user-doc/html/_r_m_s_d.html">RMSD</a> REFERENCE=../input/MacroD2_sphere_input/ref_protein_noH_nosite.pdb TYPE=SIMPLE
...
restr_rho: <a href="https://plumed.github.io/doc-master/user-doc/html/_u_p_p_e_r__w_a_l_l_s.html">UPPER_WALLS</a> ARG=rho AT=3.5 KAPPA=20000 OFFSET=0
restr_theta: <a href="https://plumed.github.io/doc-master/user-doc/html/_u_p_p_e_r__w_a_l_l_s.html">UPPER_WALLS</a> ARG=theta AT=pi/3 KAPPA=20000 OFFSET=0
...
<a href="https://plumed.github.io/doc-master/user-doc/html/_p_r_i_n_t.html">PRINT</a> ARG=restr_rho.*,restr_theta.*,restr_rmsd.* FILE=sphere_restraint.dat STRIDE=5000
...
<a href="https://plumed.github.io/doc-master/user-doc/html/_p_r_i_n_t.html">PRINT</a> ARG=rho,theta,phi FILE=rtp_coord.dat STRIDE=5000
