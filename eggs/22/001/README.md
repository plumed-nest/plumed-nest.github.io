...
**Last tested:**  27 Jun 2025, 18:08:46
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,OPT_AVERAGED_SGD,BF_GAUSSIANS,DISTANCE,TD_UNIFORM,VES_OUTPUT_BASISFUNCTIONS,METAD,BF_LEGENDRE,UNITS,FLUSH,POSITION,VES_LINEAR_EXPANSION,UPPER_WALLS,OPT_ADAM,COORDINATION,BF_WAVELETS,INCLUDE,ENERGY,TD_WELLTEMPERED,BF_CHEBYSHEV,BF_CUBIC_B_SPLINES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
