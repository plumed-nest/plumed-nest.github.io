...
**Last tested:**  20 Apr 2026, 09:41:30
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=SMAC,DFSCLUSTERING,CLUSTER_PROPERTIES,METAD,CONTACT_MATRIX,OUTPUT_CLUSTER,ONES,DISTANCES,CUSTOM,MATRIX_VECTOR_PRODUCT,CLUSTER_DISTRIBUTION,CLUSTER_NATOMS,PRINT,LOCAL_Q6,Q6,MORE_THAN,COORDINATIONNUMBER,OUTER_PRODUCT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
