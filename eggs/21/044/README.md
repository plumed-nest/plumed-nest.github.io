...
**Last tested:**  15 May 2025, 08:31:16
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CONTACT_MATRIX,COORDINATIONNUMBER,INSPHERE,PRINT,LOCAL_Q6,Q6,FIXEDATOM,HISTOGRAM,CLUSTER_NATOMS,DFSCLUSTERING,GROUP,COMBINE,MFILTER_MORE,DUMPGRID,CLUSTER_DISTRIBUTION,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
