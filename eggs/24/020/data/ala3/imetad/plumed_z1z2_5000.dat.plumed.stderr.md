...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.z4mHek.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.z4mHek.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.z4mHek.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.z4mHek.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.z4mHek.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.z4mHek.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.z4mHek.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.z4mHek.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.z4mHek.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.z4mHek.cpp:197:3: error: ‘Matrix’ was not declared in this scope
197 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.z4mHek.cpp:197:10: error: expected primary-expression before ‘double’
197 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.z4mHek.cpp:198:16: error: expected primary-expression before ‘>’ token
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.z4mHek.cpp:198:18: error: ‘dist_deriv_mat’ was not declared in this scope
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.z4mHek.cpp:213:7: error: ‘dist_mat’ was not declared in this scope
213 |       dist_mat[i][j] = value;
|       ^~~~~~~~
Graph.z4mHek.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
Graph.z4mHek.cpp:232:19: error: ‘dist_mat’ was not declared in this scope
...
[pkrvmberfyhpb9w:06978] *** Process received signal ***
[pkrvmberfyhpb9w:06978] Signal: Aborted (6)
[pkrvmberfyhpb9w:06978] Signal code:  (-6)
[pkrvmberfyhpb9w:06978] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f8edd045330]
[pkrvmberfyhpb9w:06978] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f8edd09eb2c]
[pkrvmberfyhpb9w:06978] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f8edd04527e]
[pkrvmberfyhpb9w:06978] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f8edd0288ff]
[pkrvmberfyhpb9w:06978] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f8edd4a5ff5]
[pkrvmberfyhpb9w:06978] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f8edd4bb0da]
[pkrvmberfyhpb9w:06978] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f8edd4a5a55]
[pkrvmberfyhpb9w:06978] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f8edd4a5a6f]
[pkrvmberfyhpb9w:06978] [ 8] plumed(+0x146dd)[0x556953d876dd]
[pkrvmberfyhpb9w:06978] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f8edd02a1ca]
[pkrvmberfyhpb9w:06978] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f8edd02a28b]
[pkrvmberfyhpb9w:06978] [11] plumed(+0x15365)[0x556953d88365]
[pkrvmberfyhpb9w:06978] *** End of error message ***
</pre>
{% endraw %}
