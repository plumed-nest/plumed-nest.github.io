...
**Last tested:**  03 Jul 2025, 13:07:12
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,PRINT,UPPER_WALLS,DISTANCE,COORDINATION,WHOLEMOLECULES,FIT_TO_TEMPLATE,TORSION,PATH,LOWER_WALLS,RESTART,CENTER,PYTORCH_MODEL,FIXEDATOM,OPES_METAD,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
