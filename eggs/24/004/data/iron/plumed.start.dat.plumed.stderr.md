...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.qfDOkO.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.qfDOkO.cpp:45:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.qfDOkO.cpp:45:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
45 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.qfDOkO.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.qfDOkO.cpp:81:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
81 |   bool serial,pbc;
|               ^~~
Graph.qfDOkO.cpp:81:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
81 |   bool serial,pbc;
|        ^~~~~~
Graph.qfDOkO.cpp:106:1: warning:   when initialized here [-Wreorder]
106 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.qfDOkO.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.qfDOkO.cpp:176:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.qfDOkO.cpp:177:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
177 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.qfDOkO.cpp:182:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
182 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.qfDOkO.cpp:183:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
183 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.qfDOkO.cpp:186:3: error: ‘Matrix’ was not declared in this scope
186 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.qfDOkO.cpp:186:10: error: expected primary-expression before ‘double’
186 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.qfDOkO.cpp:187:10: error: expected primary-expression before ‘double’
187 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.qfDOkO.cpp:188:16: error: expected primary-expression before ‘>’ token
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.qfDOkO.cpp:188:18: error: ‘dist_deriv_mat’ was not declared in this scope
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.qfDOkO.cpp:208:11: error: ‘dist_mat’ was not declared in this scope
208 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.qfDOkO.cpp:209:11: error: ‘idxn_mat’ was not declared in this scope
209 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.qfDOkO.cpp:215:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
215 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.qfDOkO.cpp:215:18: error: ‘dist_mat’ was not declared in this scope
215 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.qfDOkO.cpp:216:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
216 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.qfDOkO.cpp:216:18: error: ‘idxn_mat’ was not declared in this scope
216 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.qfDOkO.cpp:217:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
217 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.qfDOkO.cpp:221:25: error: ‘dist_mat’ was not declared in this scope
221 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.qfDOkO.cpp:222:25: error: ‘idxn_mat’ was not declared in this scope
222 |   vector<double> input2=idxn_mat.getVector();
|                         ^~~~~~~~
Graph.qfDOkO.cpp:269:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[runnervmkj6or:08172] *** Process received signal ***
[runnervmkj6or:08172] Signal: Aborted (6)
[runnervmkj6or:08172] Signal code:  (-6)
[runnervmkj6or:08172] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fb1b1645330]
[runnervmkj6or:08172] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fb1b169eb2c]
[runnervmkj6or:08172] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fb1b164527e]
[runnervmkj6or:08172] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fb1b16288ff]
[runnervmkj6or:08172] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fb1b1aa5ff5]
[runnervmkj6or:08172] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fb1b1abb0da]
[runnervmkj6or:08172] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fb1b1aa5a55]
[runnervmkj6or:08172] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fb1b1aa5a6f]
[runnervmkj6or:08172] [ 8] plumed(+0x146dd)[0x55d10bef96dd]
[runnervmkj6or:08172] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fb1b162a1ca]
[runnervmkj6or:08172] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fb1b162a28b]
[runnervmkj6or:08172] [11] plumed(+0x15365)[0x55d10befa365]
[runnervmkj6or:08172] *** End of error message ***
</pre>
{% endraw %}
