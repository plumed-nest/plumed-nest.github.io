...
**Last tested:**  17 Jul 2025, 15:20:17
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,CLUSTER_DISTRIBUTION,LOAD,MULTICOLVARDENS,RESTRAINT,CLUSTER_NATOMS,DFSCLUSTERING,DUMPGRID,MFILTER_MORE,GROUP,FIXEDATOM,COORDINATIONNUMBER,CONTACT_MATRIX,DENSITY,AROUND" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
