...
**Last tested:**  22 Aug 2026, 14:33:45
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,LOWER_WALLS,GROUP,MATHEVAL,ECV_MULTITHERMAL,ENERGY,OPES_METAD_EXPLORE,PRINT,CENTER,OPES_EXPANDED,DISTANCE,ENDPLUMED,COORDINATION,FIXEDATOM,UPPER_WALLS,ANGLE,TORSION,FIT_TO_TEMPLATE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
