...
**Last tested:**  17 Jul 2025, 15:10:52
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPT_AVERAGED_SGD,VES_LINEAR_EXPANSION,ENERGY,BF_CHEBYSHEV,UPPER_WALLS,POSITION,BF_WAVELETS,TD_UNIFORM,VES_OUTPUT_BASISFUNCTIONS,TD_WELLTEMPERED,DISTANCE,BF_CUBIC_B_SPLINES,UNITS,OPT_ADAM,BF_LEGENDRE,FLUSH,BF_GAUSSIANS,METAD,INCLUDE,PRINT,COORDINATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
