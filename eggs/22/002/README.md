...
**Last tested:**  11 Nov 2025, 09:59:01
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ANGLE,CENTER,FIT_TO_TEMPLATE,ENDPLUMED,DISTANCE,WHOLEMOLECULES,PYTORCH_MODEL,FLUSH,LOAD,COORDINATION,PRINT,ENERGY,UPPER_WALLS,FIXEDATOM,COMMITTOR,GROUP,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
