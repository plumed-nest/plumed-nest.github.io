...
**Last tested:**  21 Jun 2025, 13:38:09
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=HISTOGRAM,PRINT,DUMPGRID,CONTACT_MATRIX,Q3,LOAD,DFSCLUSTERING,COORDINATIONNUMBER,GROUP,DENSITY,FIXEDATOM,LOCAL_Q3,CLUSTER_NATOMS,UNITS,RESTRAINT,CLUSTER_DISTRIBUTION,LOCAL_AVERAGE,AROUND" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
