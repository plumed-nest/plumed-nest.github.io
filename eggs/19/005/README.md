...
**Last tested:**  15 Jan 2026, 17:26:35
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,CENTER,MOLINFO,ALPHABETA,INCLUDE,PBMETAD,GROUP,GYRATION,WHOLEMOLECULES,CS2BACKBONE,COORDINATION,METAINFERENCE,DISTANCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
