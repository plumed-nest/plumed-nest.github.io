...
**Last tested:**  22 Aug 2026, 14:44:45
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UNITS,LOCAL_Q3,DUMPGRID,DFSCLUSTERING,CLUSTER_DISTRIBUTION,LOCAL_AVERAGE,PRINT,Q3,GROUP,HISTOGRAM,COORDINATIONNUMBER,CLUSTER_NATOMS,LOAD,DENSITY,AROUND,RESTRAINT,FIXEDATOM,CONTACT_MATRIX" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
