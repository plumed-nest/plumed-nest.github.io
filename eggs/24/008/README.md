...
**Last tested:**  03 Feb 2026, 21:04:24
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=INCLUDE,UPPER_WALLS,COM,FIXEDATOM,WRAPAROUND,MOLINFO,DUMPGRID,REWEIGHT_METAD,METAD,DISTANCE,CONTACTMAP,GROUP,MATHEVAL,FIT_TO_TEMPLATE,COMMITTOR,ENDPLUMED,PATH,FLUSH,READ,CONVERT_TO_FES,PRINT,HISTOGRAM,COORDINATION,RMSD,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
