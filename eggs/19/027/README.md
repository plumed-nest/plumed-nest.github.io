...
**Last tested:**  21 Jun 2025, 13:58:20
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=HISTOGRAM,COMBINE,REWEIGHT_BIAS,PRINT,DUMPGRID,VES_LINEAR_EXPANSION,ENERGY,OPT_AVERAGED_SGD,REWEIGHT_TEMP_PRESS,OPT_DUMMY,AVERAGE,CONVERT_TO_FES,RESTART,READ,TD_MULTICANONICAL,BF_LEGENDRE,UNITS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
