...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.3YRuwV.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.3YRuwV.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.3YRuwV.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.3YRuwV.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.3YRuwV.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.3YRuwV.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.3YRuwV.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.3YRuwV.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.3YRuwV.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.3YRuwV.cpp:197:3: error: ‘Matrix’ was not declared in this scope
197 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.3YRuwV.cpp:197:10: error: expected primary-expression before ‘double’
197 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.3YRuwV.cpp:198:16: error: expected primary-expression before ‘>’ token
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.3YRuwV.cpp:198:18: error: ‘dist_deriv_mat’ was not declared in this scope
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.3YRuwV.cpp:213:7: error: ‘dist_mat’ was not declared in this scope
213 |       dist_mat[i][j] = value;
|       ^~~~~~~~
Graph.3YRuwV.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
Graph.3YRuwV.cpp:232:19: error: ‘dist_mat’ was not declared in this scope
...
[runnervmvrwv9:05568] *** Process received signal ***
[runnervmvrwv9:05568] Signal: Aborted (6)
[runnervmvrwv9:05568] Signal code:  (-6)
[runnervmvrwv9:05568] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fb6b8c45330]
[runnervmvrwv9:05568] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fb6b8c9eb2c]
[runnervmvrwv9:05568] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fb6b8c4527e]
[runnervmvrwv9:05568] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fb6b8c288ff]
[runnervmvrwv9:05568] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fb6b90a5ff5]
[runnervmvrwv9:05568] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fb6b90bb0da]
[runnervmvrwv9:05568] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fb6b90a5a55]
[runnervmvrwv9:05568] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fb6b90a5a6f]
[runnervmvrwv9:05568] [ 8] plumed(+0x146dd)[0x55db3ccf76dd]
[runnervmvrwv9:05568] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fb6b8c2a1ca]
[runnervmvrwv9:05568] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fb6b8c2a28b]
[runnervmvrwv9:05568] [11] plumed(+0x15365)[0x55db3ccf8365]
[runnervmvrwv9:05568] *** End of error message ***
</pre>
{% endraw %}
