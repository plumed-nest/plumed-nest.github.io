...
**Last tested:**  21 Jun 2025, 13:43:15
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,CENTER,GROUP,FIT_TO_TEMPLATE,MATHEVAL,DISTANCE,UPPER_WALLS,OPES_METAD,PRINT,CUSTOM,COMMITTOR,LOWER_WALLS,RMSD,WHOLEMOLECULES,FIXEDATOM,PYTORCH_MODEL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
