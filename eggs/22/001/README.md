...
**Last tested:**  29 Jun 2026, 10:17:39
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPT_AVERAGED_SGD,BF_CUBIC_B_SPLINES,OPT_ADAM,PRINT,UNITS,VES_LINEAR_EXPANSION,DISTANCE,INCLUDE,TD_UNIFORM,COORDINATION,UPPER_WALLS,BF_LEGENDRE,ENERGY,BF_GAUSSIANS,BF_CHEBYSHEV,FLUSH,METAD,BF_WAVELETS,POSITION,TD_WELLTEMPERED,VES_OUTPUT_BASISFUNCTIONS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
