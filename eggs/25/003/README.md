...
**Last tested:**  21 Jun 2025, 13:36:48
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,ENERGY,MATHEVAL,CUSTOM,COMBINE,OPES_METAD,ENDPLUMED,PRINT,GROUP,PYTORCH_MODEL,COMMITTOR,TORSION,DISTANCE,MOLINFO" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
