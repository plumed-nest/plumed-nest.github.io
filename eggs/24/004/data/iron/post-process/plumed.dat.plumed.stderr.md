...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.fxWfOE.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.fxWfOE.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.fxWfOE.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.fxWfOE.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.fxWfOE.cpp:82:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
82 |   bool serial,pbc;
|               ^~~
Graph.fxWfOE.cpp:82:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
82 |   bool serial,pbc;
|        ^~~~~~
Graph.fxWfOE.cpp:107:1: warning:   when initialized here [-Wreorder]
107 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.fxWfOE.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.fxWfOE.cpp:179:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.fxWfOE.cpp:180:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
180 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.fxWfOE.cpp:185:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
185 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.fxWfOE.cpp:186:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
186 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.fxWfOE.cpp:189:3: error: ‘Matrix’ was not declared in this scope
189 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.fxWfOE.cpp:189:10: error: expected primary-expression before ‘double’
189 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.fxWfOE.cpp:190:10: error: expected primary-expression before ‘double’
190 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.fxWfOE.cpp:191:16: error: expected primary-expression before ‘>’ token
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.fxWfOE.cpp:191:18: error: ‘dist_deriv_mat’ was not declared in this scope
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.fxWfOE.cpp:211:11: error: ‘dist_mat’ was not declared in this scope
211 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.fxWfOE.cpp:212:11: error: ‘idxn_mat’ was not declared in this scope
212 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.fxWfOE.cpp:218:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
218 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.fxWfOE.cpp:218:18: error: ‘dist_mat’ was not declared in this scope
218 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.fxWfOE.cpp:219:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.fxWfOE.cpp:219:18: error: ‘idxn_mat’ was not declared in this scope
219 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.fxWfOE.cpp:220:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
220 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.fxWfOE.cpp:224:25: error: ‘dist_mat’ was not declared in this scope
224 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.fxWfOE.cpp:225:25: error: ‘idxn_mat’ was not declared in this scope
...
[pkrvmpptgkbjq6m:08263] *** Process received signal ***
[pkrvmpptgkbjq6m:08263] Signal: Aborted (6)
[pkrvmpptgkbjq6m:08263] Signal code:  (-6)
[pkrvmpptgkbjq6m:08263] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f3d3fa45330]
[pkrvmpptgkbjq6m:08263] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f3d3fa9eb2c]
[pkrvmpptgkbjq6m:08263] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f3d3fa4527e]
[pkrvmpptgkbjq6m:08263] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f3d3fa288ff]
[pkrvmpptgkbjq6m:08263] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f3d3fea5ff5]
[pkrvmpptgkbjq6m:08263] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f3d3febb0da]
[pkrvmpptgkbjq6m:08263] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f3d3fea5a55]
[pkrvmpptgkbjq6m:08263] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f3d3fea5a6f]
[pkrvmpptgkbjq6m:08263] [ 8] plumed(+0x146dd)[0x55b7e37496dd]
[pkrvmpptgkbjq6m:08263] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f3d3fa2a1ca]
[pkrvmpptgkbjq6m:08263] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f3d3fa2a28b]
[pkrvmpptgkbjq6m:08263] [11] plumed(+0x15365)[0x55b7e374a365]
[pkrvmpptgkbjq6m:08263] *** End of error message ***
</pre>
{% endraw %}
