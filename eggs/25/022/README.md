...
**Publication:** [S. K. Ethirajan, A. R. Kulkarni, Modeling Diffusion in Metal-Organic Frameworks using On-the-fly Probability Enhanced Sampling-based Machine Learning Potentials. doi: 10.26434/chemrxiv-2025-mg7qj-v2 (2025)](http://dx.doi.org/10.26434/chemrxiv-2025-mg7qj-v2)  
...
**Last tested:**  20 Apr 2026, 09:13:29
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPES_METAD,MOLINFO,DISTANCE,ENDPLUMED,CENTER,UNITS,PROJECTION_ON_AXIS,DISTANCES,PRINT,WHOLEMOLECULES,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
