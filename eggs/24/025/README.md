...
**Last tested:**  10 Mar 2026, 11:04:53
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=RESTART,COORDINATION,GROUP,WHOLEMOLECULES,FIT_TO_TEMPLATE,DISTANCE,OPES_METAD,PRINT,CENTER,UPPER_WALLS,TORSION,FIXEDATOM,CUSTOM,PATH,PYTORCH_MODEL,LOWER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
