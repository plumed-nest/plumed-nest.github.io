...
**Last tested:**  03 Feb 2026, 21:14:06
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,METAD,COORDINATION,COM,LOWER_WALLS,OPES_METAD_EXPLORE,GROUP,CENTER,DISTANCE,UPPER_WALLS,WHOLEMOLECULES,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
