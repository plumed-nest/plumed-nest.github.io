...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,CLUSTER_DISTRIBUTION,PRINT,CONTACT_MATRIX,GROUP,CLUSTER_NATOMS,MFILTER_MORE,MULTICOLVARDENS,COORDINATIONNUMBER,DUMPGRID,RESTRAINT,LOAD,DENSITY,AROUND,DFSCLUSTERING" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
