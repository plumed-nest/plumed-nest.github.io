...
**Last tested:**  29 May 2025, 07:04:54
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,FLUSH,OPT_AVERAGED_SGD,BF_GAUSSIANS,INCLUDE,PRINT,TD_UNIFORM,DISTANCE,POSITION,TD_WELLTEMPERED,UNITS,BF_LEGENDRE,BF_CUBIC_B_SPLINES,METAD,VES_OUTPUT_BASISFUNCTIONS,UPPER_WALLS,ENERGY,BF_WAVELETS,OPT_ADAM,BF_CHEBYSHEV,VES_LINEAR_EXPANSION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
