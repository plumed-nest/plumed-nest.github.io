...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.EWf8Rd.cpp: In static member function ‘static void PLMD::colvar::GraphGenerator::registerKeywords(PLMD::Keywords&)’:
Graph.EWf8Rd.cpp:73:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
Graph.EWf8Rd.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.EWf8Rd.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.EWf8Rd.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.EWf8Rd.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.EWf8Rd.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.EWf8Rd.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.EWf8Rd.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.EWf8Rd.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.EWf8Rd.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.EWf8Rd.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
...
[runnervmw9dnm:07043] *** Process received signal ***
[runnervmw9dnm:07043] Signal: Aborted (6)
[runnervmw9dnm:07043] Signal code:  (-6)
[runnervmw9dnm:07043] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fa61f245330]
[runnervmw9dnm:07043] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fa61f29eb2c]
[runnervmw9dnm:07043] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fa61f24527e]
[runnervmw9dnm:07043] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fa61f2288ff]
[runnervmw9dnm:07043] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fa61f6a5ff5]
[runnervmw9dnm:07043] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fa61f6bb0da]
[runnervmw9dnm:07043] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fa61f6a5a55]
[runnervmw9dnm:07043] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fa61f6a5a6f]
[runnervmw9dnm:07043] [ 8] plumed_master(+0x146dd)[0x56508b8186dd]
[runnervmw9dnm:07043] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fa61f22a1ca]
[runnervmw9dnm:07043] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fa61f22a28b]
[runnervmw9dnm:07043] [11] plumed_master(+0x15365)[0x56508b819365]
[runnervmw9dnm:07043] *** End of error message ***
</pre>
{% endraw %}
