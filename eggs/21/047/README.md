...
**Last tested:**  03 Jul 2025, 13:22:59
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENERGY,VOLUME,COMBINE,RESTART,BF_LEGENDRE,LOAD,TD_WELLTEMPERED,VES_LINEAR_EXPANSION,PRINT,METAD,OPT_AVERAGED_SGD,PAIRENTROPY" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
