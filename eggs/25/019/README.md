...
**Last tested:**  22 Aug 2026, 14:33:04
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENERGY,CENTER,COMBINE,GHOST,OPES_METAD_EXPLORE,GROUP,MOLINFO,COORDINATION,ECV_MULTITHERMAL,DISTANCE,PRINT,CUSTOM,RMSD,OPES_EXPANDED" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
