...
**Last tested:**  22 May 2025, 18:22:51
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FLUSH,GROUP,UPPER_WALLS,FIT_TO_TEMPLATE,WHOLEMOLECULES,PRINT,ENERGY,COORDINATION,LOAD,COMMITTOR,ENDPLUMED,DISTANCE,MATHEVAL,FIXEDATOM,PYTORCH_MODEL,CENTER,ANGLE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
