...
**Last tested:**  03 Feb 2026, 21:22:39
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENSEMBLE,SAXS,ALPHABETA,COORDINATION,INCLUDE,CENTER,WHOLEMOLECULES,GROUP,PRINT,MOLINFO,STATS,MATHEVAL,ENDPLUMED,ANGLE,PBMETAD,COMBINE,BIASVALUE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
