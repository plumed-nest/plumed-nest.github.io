...
**Last tested:**  27 Jun 2025, 17:56:56
  
**Project description and instructions**  
Input files to reproduce results of the paper "Into the dynamics of rotaxanes at atomistic resolution"
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,CENTER,TORSION,PRINT,UPPER_WALLS,CUSTOM,MATHEVAL,DISTANCE,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
