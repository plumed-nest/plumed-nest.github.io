...
**Last tested:**  06 May 2025, 07:05:46
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=AVERAGE,VES_LINEAR_EXPANSION,DUMPGRID,BF_LEGENDRE,COMBINE,TD_MULTICANONICAL,REWEIGHT_BIAS,REWEIGHT_TEMP_PRESS,OPT_AVERAGED_SGD,PRINT,ENERGY,OPT_DUMMY,UNITS,CONVERT_TO_FES,HISTOGRAM,RESTART,READ" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
