...
**Last tested:**  11 Nov 2025, 09:47:42
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENERGY,PRINT,TORSION,DISTANCE,CENTER,FIT_TO_TEMPLATE,OPES_METAD_EXPLORE,MATHEVAL,ENDPLUMED,COORDINATION,UPPER_WALLS,ANGLE,FIXEDATOM,GROUP,OPES_EXPANDED,LOWER_WALLS,WHOLEMOLECULES,ECV_MULTITHERMAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
