...
**Last tested:**  22 May 2025, 18:12:37
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,CONTACT_MATRIX,LOCAL_Q3,HISTOGRAM,CLUSTER_NATOMS,RESTRAINT,LOAD,GROUP,UNITS,Q3,DUMPGRID,DENSITY,AROUND,LOCAL_AVERAGE,DFSCLUSTERING,CLUSTER_DISTRIBUTION,COORDINATIONNUMBER,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
