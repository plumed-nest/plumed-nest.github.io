...
**Last tested:**  11 Nov 2025, 09:54:45
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,OPES_METAD,PYTORCH_MODEL,MATHEVAL,DISTANCE,FIXEDATOM,RMSD,CONTACTMAP,WHOLEMOLECULES,COORDINATION,COMMITTOR,CUSTOM,ENDPLUMED,COMBINE,GROUP,FIT_TO_TEMPLATE,CENTER,INCLUDE,MOLINFO,ENERGY,UPPER_WALLS,ANGLE,LOWER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
