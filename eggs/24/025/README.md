...
**Last tested:**  29 May 2025, 06:50:52
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,CUSTOM,CENTER,WHOLEMOLECULES,COORDINATION,PYTORCH_MODEL,PRINT,FIXEDATOM,RESTART,GROUP,LOWER_WALLS,OPES_METAD,UPPER_WALLS,TORSION,PATH,DISTANCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
