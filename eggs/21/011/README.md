...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATIONNUMBER,PRINT,CLUSTER_DISTRIBUTION,AROUND,RESTRAINT,GROUP,CLUSTER_NATOMS,FIXEDATOM,CONTACT_MATRIX,MFILTER_MORE,MULTICOLVARDENS,DENSITY,DFSCLUSTERING,DUMPGRID,LOAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
