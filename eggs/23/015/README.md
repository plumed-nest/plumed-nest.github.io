...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CENTER,UPPER_WALLS,LOWER_WALLS,WHOLEMOLECULES,GROUP,DISTANCE,CUSTOM,COORDINATION,PRINT,OPES_METAD_EXPLORE,METAD,COM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
