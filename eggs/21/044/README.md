...
**Last tested:**  10 Mar 2026, 11:10:51
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=INSPHERE,HISTOGRAM,DUMPGRID,Q6,GROUP,MFILTER_MORE,COMBINE,PRINT,DFSCLUSTERING,COORDINATIONNUMBER,FIXEDATOM,CLUSTER_NATOMS,CONTACT_MATRIX,LOCAL_Q6,METAD,CLUSTER_DISTRIBUTION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
