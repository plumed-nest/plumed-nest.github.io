...
**Last tested:**  15 Jan 2026, 17:07:43
  
**Project description and instructions**  
Initial configurations, run files for GROMACS and two complete examples of metadynamics are included.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GYRATION,MOLINFO,LOWER_WALLS,DISTANCE,PBMETAD,UPPER_WALLS,PRINT,COM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
