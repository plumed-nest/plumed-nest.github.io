...
**Last tested:**  17 Jul 2025, 15:00:20
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPES_EXPANDED,ECV_MULTITHERMAL,ENERGY,ANGLE,DISTANCE,FIXEDATOM,TORSION,CENTER,MATHEVAL,GROUP,ENDPLUMED,UPPER_WALLS,WHOLEMOLECULES,OPES_METAD_EXPLORE,FIT_TO_TEMPLATE,LOWER_WALLS,COORDINATION,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
