...
**Last tested:**  22 Aug 2026, 14:30:56
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=INCLUDE,WHOLEMOLECULES,READ,PBMETAD,ENERGY,PRINT,CENTER,UPDATE_IF,DISTANCE,DUMPATOMS,VOLUME,TORSION,GYRATION,MOLINFO,RESTART" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
