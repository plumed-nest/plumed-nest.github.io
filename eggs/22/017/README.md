...
**Last tested:**  17 Jul 2025, 15:09:41
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PYTORCH_MODEL,DISTANCE,OPES_METAD,RMSD,CENTER,MATHEVAL,GROUP,CUSTOM,UPPER_WALLS,WHOLEMOLECULES,FIXEDATOM,FIT_TO_TEMPLATE,LOWER_WALLS,COMMITTOR,COORDINATION,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
