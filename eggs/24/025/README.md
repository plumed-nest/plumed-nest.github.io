...
**Last tested:**  15 May 2025, 08:12:59
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,WHOLEMOLECULES,PYTORCH_MODEL,PATH,LOWER_WALLS,CUSTOM,TORSION,FIT_TO_TEMPLATE,GROUP,DISTANCE,FIXEDATOM,RESTART,CENTER,PRINT,UPPER_WALLS,OPES_METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
