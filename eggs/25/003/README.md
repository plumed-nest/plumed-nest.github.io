...
**Last tested:**  03 Jul 2025, 13:02:46
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DISTANCE,PRINT,COMBINE,COMMITTOR,ENERGY,GROUP,MOLINFO,MATHEVAL,WHOLEMOLECULES,TORSION,PYTORCH_MODEL,ENDPLUMED,OPES_METAD,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
