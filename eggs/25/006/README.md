...
**Last tested:**  10 Mar 2026, 10:55:52
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=VOLUME,MOLINFO,TORSION,PBMETAD,INCLUDE,ENERGY,DISTANCE,GYRATION,DUMPATOMS,UPDATE_IF,RESTART,READ,PRINT,CENTER,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
