...
**Last tested:**  03 Feb 2026, 21:04:15
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,VOLUME,READ,MOLINFO,ENERGY,INCLUDE,GYRATION,UPDATE_IF,TORSION,CENTER,DISTANCE,RESTART,PBMETAD,DUMPATOMS,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
