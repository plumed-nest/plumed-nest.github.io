...
**Last tested:**  03 Jul 2025, 13:32:58
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ALPHABETA,CS2BACKBONE,METAINFERENCE,INCLUDE,DISTANCE,MOLINFO,COORDINATION,GROUP,CENTER,GYRATION,PRINT,WHOLEMOLECULES,PBMETAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
