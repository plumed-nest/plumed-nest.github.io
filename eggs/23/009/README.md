...
**Last tested:**  17 Jul 2025, 15:06:10
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,COMBINE,CUSTOM,UPPER_WALLS,OPES_METAD,MATHEVAL,COORDINATION,CENTER,RMSD,CONTACTMAP,MOLINFO,LOWER_WALLS,INCLUDE,ENERGY,FIXEDATOM,ENDPLUMED,WHOLEMOLECULES,DISTANCE,PRINT,COMMITTOR,PYTORCH_MODEL,ANGLE,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
