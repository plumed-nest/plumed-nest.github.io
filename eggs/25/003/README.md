...
**Last tested:**  27 Jul 2026, 19:20:29
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENDPLUMED,MOLINFO,WHOLEMOLECULES,DISTANCE,COMBINE,TORSION,CUSTOM,COMMITTOR,GROUP,PRINT,ENERGY,OPES_METAD,MATHEVAL,PYTORCH_MODEL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
