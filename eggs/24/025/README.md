...
**Last tested:**  11 Nov 2025, 09:50:12
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PATH,FIXEDATOM,LOWER_WALLS,PRINT,GROUP,CENTER,TORSION,CUSTOM,FIT_TO_TEMPLATE,COORDINATION,WHOLEMOLECULES,RESTART,PYTORCH_MODEL,UPPER_WALLS,OPES_METAD,DISTANCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
