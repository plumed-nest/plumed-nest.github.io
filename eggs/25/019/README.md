...
**Last tested:**  29 Jun 2026, 10:11:10
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GHOST,RMSD,ECV_MULTITHERMAL,GROUP,ENERGY,COORDINATION,CENTER,OPES_METAD_EXPLORE,PRINT,CUSTOM,DISTANCE,OPES_EXPANDED,COMBINE,MOLINFO" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
