...
**Last tested:**  27 Jun 2025, 18:04:23
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,CENTER,ENERGY,ANGLE,COMMITTOR,PRINT,PYTORCH_MODEL,ENDPLUMED,FIT_TO_TEMPLATE,UPPER_WALLS,FLUSH,GROUP,WHOLEMOLECULES,COORDINATION,LOAD,MATHEVAL,DISTANCE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
