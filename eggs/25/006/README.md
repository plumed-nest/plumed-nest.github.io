...
**Last tested:**  27 Jul 2026, 19:15:20
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=INCLUDE,CENTER,MOLINFO,GYRATION,VOLUME,DISTANCE,ENERGY,READ,DUMPATOMS,RESTART,PBMETAD,TORSION,UPDATE_IF,WHOLEMOLECULES,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
