...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MOLINFO,PATHMSD,METAD,DISTANCE,PRINT,LOWER_WALLS,INCLUDE,FUNCPATHMSD,UPPER_WALLS,ALPHARMSD,CONTACTMAP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
