...
**Last tested:**  27 Jul 2026, 19:22:44
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,GROUP,FLUSH,RMSD,ENERGY,COMBINE,METAD,PYTORCH_MODEL,CENTER,LOWER_WALLS,DISTANCE,ENDPLUMED,INCLUDE,MOLINFO,CONTACTMAP,PRINT,COORDINATION,POSITION,UPPER_WALLS,BIASVALUE,OPES_METAD_EXPLORE,OPES_METAD,CUSTOM,WHOLEMOLECULES,UNITS,FIT_TO_TEMPLATE,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
