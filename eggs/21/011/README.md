...
**Last tested:**  27 Jul 2026, 19:33:55
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=AROUND,GROUP,RESTRAINT,DFSCLUSTERING,DENSITY,COORDINATIONNUMBER,CONTACT_MATRIX,MULTICOLVARDENS,MFILTER_MORE,FIXEDATOM,CLUSTER_DISTRIBUTION,LOAD,CLUSTER_NATOMS,PRINT,DUMPGRID" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
