...
**Last tested:**  25 Jul 2025, 11:35:48
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,LOWER_WALLS,ANGLE,MATHEVAL,OPES_METAD_EXPLORE,PRINT,TORSION,DISTANCE,FIT_TO_TEMPLATE,GROUP,UPPER_WALLS,ENERGY,ECV_MULTITHERMAL,OPES_EXPANDED,CENTER,COORDINATION,WHOLEMOLECULES,ENDPLUMED" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
