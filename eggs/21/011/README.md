...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=RESTRAINT,GROUP,CLUSTER_NATOMS,MFILTER_MORE,MULTICOLVARDENS,CLUSTER_DISTRIBUTION,DUMPGRID,DFSCLUSTERING,LOAD,FIXEDATOM,AROUND,COORDINATIONNUMBER,CONTACT_MATRIX,PRINT,DENSITY" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
