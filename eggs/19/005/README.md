...
**Last tested:**  27 Jul 2026, 19:43:53
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=INCLUDE,MOLINFO,PBMETAD,WHOLEMOLECULES,COORDINATION,GYRATION,CS2BACKBONE,DISTANCE,ALPHABETA,METAINFERENCE,PRINT,CENTER,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
