...
**Last tested:**  27 Jul 2026, 19:22:40
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=TORSION,GROUP,PATH,PYTORCH_MODEL,COORDINATION,FIT_TO_TEMPLATE,LOWER_WALLS,CENTER,WHOLEMOLECULES,FIXEDATOM,RESTART,DISTANCE,UPPER_WALLS,OPES_METAD,CUSTOM,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
