...
**Last tested:**  15 May 2025, 08:16:34
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,CENTER,OPES_METAD_EXPLORE,COORDINATION,COM,LOWER_WALLS,GROUP,DISTANCE,CUSTOM,METAD,WHOLEMOLECULES,UPPER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
