...
**Last tested:**  25 Jul 2025, 11:43:47
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,RMSD,GROUP,FIXEDATOM,CUSTOM,UPPER_WALLS,COORDINATION,LOWER_WALLS,OPES_METAD,PYTORCH_MODEL,FIT_TO_TEMPLATE,PRINT,CENTER,MATHEVAL,DISTANCE,COMMITTOR" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
