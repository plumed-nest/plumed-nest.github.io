...
from ../codes/StructureFactor_descriptor.test.tU3cP7.cpp:6:
...
|
../codes/StructureFactor_descriptor.test.tU3cP7.cpp: In static member function ‘static void PLMD::colvar::StructureFactor_descriptor_test::registerKeywords(PLMD::Keywords&)’:
../codes/StructureFactor_descriptor.test.tU3cP7.cpp:77:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
../codes/StructureFactor_descriptor.test.tU3cP7.cpp: In constructor ‘PLMD::colvar::StructureFactor_descriptor_test::StructureFactor_descriptor_test(const PLMD::ActionOptions&)’:
../codes/StructureFactor_descriptor.test.tU3cP7.cpp:188:41: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
188 |     NumAtom_=plumed.getAtoms().getNatoms();
|              ~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
In file included from ../codes/StructureFactor_descriptor.test.tU3cP7.cpp:8:
/home/runner/opt/include/plumed_master/core/PlumedMain.h:106:9: note: declared here
106 |     int getNatoms() const ;
|         ^~~~~~~~~
../codes/StructureFactor_descriptor.test.tU3cP7.cpp:194:108: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
...
|         ^~~~~~~~~
Assembler messages:
Fatal error: can't create plumed_mklib.qkyBnM/../codes/StructureFactor_descriptor.test.o: No such file or directory
...
[pkrvmxyh4eaekms:08926] *** Process received signal ***
[pkrvmxyh4eaekms:08926] Signal: Aborted (6)
[pkrvmxyh4eaekms:08926] Signal code:  (-6)
[pkrvmxyh4eaekms:08926] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fa1c5045330]
[pkrvmxyh4eaekms:08926] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fa1c509eb2c]
[pkrvmxyh4eaekms:08926] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fa1c504527e]
[pkrvmxyh4eaekms:08926] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fa1c50288ff]
[pkrvmxyh4eaekms:08926] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fa1c54a5ff5]
[pkrvmxyh4eaekms:08926] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fa1c54bb0da]
[pkrvmxyh4eaekms:08926] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fa1c54a5a55]
[pkrvmxyh4eaekms:08926] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fa1c54a5a6f]
[pkrvmxyh4eaekms:08926] [ 8] plumed_master(+0x146dd)[0x55dc9390f6dd]
[pkrvmxyh4eaekms:08926] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fa1c502a1ca]
[pkrvmxyh4eaekms:08926] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fa1c502a28b]
[pkrvmxyh4eaekms:08926] [11] plumed_master(+0x15365)[0x55dc93910365]
[pkrvmxyh4eaekms:08926] *** End of error message ***
</pre>
{% endraw %}
