...
**Last tested:**  21 Jun 2025, 13:34:15
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,GROUP,FIT_TO_TEMPLATE,TORSION,WHOLEMOLECULES,DISTANCE,RESTART,UPPER_WALLS,OPES_METAD,PRINT,CUSTOM,LOWER_WALLS,PATH,CENTER,FIXEDATOM,PYTORCH_MODEL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
