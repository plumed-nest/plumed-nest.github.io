...
**Last tested:**  10 Mar 2026, 11:08:26
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DISTANCE,UNITS,FIT_TO_TEMPLATE,GROUP,PYTORCH_MODEL,TORSION,UPPER_WALLS,OPES_METAD_EXPLORE,CUSTOM,PATH,FIXEDATOM,CENTER,WHOLEMOLECULES,LOWER_WALLS,OPES_METAD,PRINT,COORDINATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
