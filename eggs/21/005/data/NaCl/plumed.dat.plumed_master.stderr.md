...
from ../codes/StructureFactor_descriptor.test.K6ij6P.cpp:6:
...
|
../codes/StructureFactor_descriptor.test.K6ij6P.cpp: In static member function ‘static void PLMD::colvar::StructureFactor_descriptor_test::registerKeywords(PLMD::Keywords&)’:
../codes/StructureFactor_descriptor.test.K6ij6P.cpp:77:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
../codes/StructureFactor_descriptor.test.K6ij6P.cpp: In constructor ‘PLMD::colvar::StructureFactor_descriptor_test::StructureFactor_descriptor_test(const PLMD::ActionOptions&)’:
../codes/StructureFactor_descriptor.test.K6ij6P.cpp:188:41: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
188 |     NumAtom_=plumed.getAtoms().getNatoms();
|              ~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
In file included from ../codes/StructureFactor_descriptor.test.K6ij6P.cpp:8:
/home/runner/opt/include/plumed_master/core/PlumedMain.h:106:9: note: declared here
106 |     int getNatoms() const ;
|         ^~~~~~~~~
../codes/StructureFactor_descriptor.test.K6ij6P.cpp:194:108: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
...
|         ^~~~~~~~~
Assembler messages:
Fatal error: can't create plumed_mklib.EQOJgN/../codes/StructureFactor_descriptor.test.o: No such file or directory
...
[pkrvmq0rgcvqdmg:12853] *** Process received signal ***
[pkrvmq0rgcvqdmg:12853] Signal: Aborted (6)
[pkrvmq0rgcvqdmg:12853] Signal code:  (-6)
[pkrvmq0rgcvqdmg:12853] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f96c5245330]
[pkrvmq0rgcvqdmg:12853] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f96c529eb2c]
[pkrvmq0rgcvqdmg:12853] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f96c524527e]
[pkrvmq0rgcvqdmg:12853] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f96c52288ff]
[pkrvmq0rgcvqdmg:12853] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f96c56a5ff5]
[pkrvmq0rgcvqdmg:12853] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f96c56bb0da]
[pkrvmq0rgcvqdmg:12853] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f96c56a5a55]
[pkrvmq0rgcvqdmg:12853] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f96c56a5a6f]
[pkrvmq0rgcvqdmg:12853] [ 8] plumed_master(+0x146dd)[0x55f8072256dd]
[pkrvmq0rgcvqdmg:12853] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f96c522a1ca]
[pkrvmq0rgcvqdmg:12853] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f96c522a28b]
[pkrvmq0rgcvqdmg:12853] [11] plumed_master(+0x15365)[0x55f807226365]
[pkrvmq0rgcvqdmg:12853] *** End of error message ***
</pre>
{% endraw %}
