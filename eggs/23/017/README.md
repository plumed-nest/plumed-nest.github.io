...
**Last tested:**  15 Jan 2026, 17:09:20
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PYTORCH_MODEL,TORSION,OPES_METAD_EXPLORE,PATH,LOWER_WALLS,DISTANCE,FIT_TO_TEMPLATE,OPES_METAD,UPPER_WALLS,GROUP,CUSTOM,PRINT,CENTER,FIXEDATOM,UNITS,COORDINATION,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
