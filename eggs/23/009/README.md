...
**Last tested:**  25 Jul 2025, 11:38:55
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CUSTOM,FIT_TO_TEMPLATE,FIXEDATOM,COORDINATION,ANGLE,COMMITTOR,CENTER,OPES_METAD,GROUP,ENDPLUMED,COMBINE,RMSD,WHOLEMOLECULES,ENERGY,UPPER_WALLS,PYTORCH_MODEL,CONTACTMAP,INCLUDE,DISTANCE,PRINT,MATHEVAL,LOWER_WALLS,MOLINFO" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
