...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PATHMSD,METAD,COM,VORONOI,SKETCHMAP_PROJECTION,COLLECT_FRAMES,TRANSPOSE,VSTACK,LANDMARK_SELECT_FPS,CUSTOM,DISSIMILARITIES,PRINT,DISTANCE,UPPER_WALLS,WHOLEMOLECULES,SKETCHMAP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
