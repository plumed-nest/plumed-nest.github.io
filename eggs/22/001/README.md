...
**Last tested:**  01 Sep 2026, 14:34:57
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPT_AVERAGED_SGD,VES_LINEAR_EXPANSION,FLUSH,BF_CUBIC_B_SPLINES,PRINT,COORDINATION,TD_UNIFORM,BF_CHEBYSHEV,OPT_ADAM,BF_LEGENDRE,UNITS,VES_OUTPUT_BASISFUNCTIONS,ENERGY,UPPER_WALLS,DISTANCE,BF_GAUSSIANS,POSITION,TD_WELLTEMPERED,METAD,INCLUDE,BF_WAVELETS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
