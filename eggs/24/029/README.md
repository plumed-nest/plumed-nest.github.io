...
**Last tested:**  15 Jan 2026, 17:02:28
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,OPES_METAD_EXPLORE,COMBINE,ENDPLUMED,RMSD,CONTACTMAP,UPPER_WALLS,OPES_METAD,METAD,FLUSH,WHOLEMOLECULES,PYTORCH_MODEL,POSITION,MOLINFO,COORDINATION,GROUP,INCLUDE,ENERGY,BIASVALUE,FIXEDATOM,LOWER_WALLS,DISTANCE,CUSTOM,UNITS,MATHEVAL,CENTER,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
