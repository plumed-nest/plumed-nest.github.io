...
**Last tested:**  10 Mar 2026, 10:58:39
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,DISTANCE,WHOLEMOLECULES,UPPER_WALLS,ANGLE,TORSION,FIT_TO_TEMPLATE,PRINT,ECV_MULTITHERMAL,OPES_EXPANDED,FIXEDATOM,MATHEVAL,COORDINATION,ENERGY,CENTER,LOWER_WALLS,OPES_METAD_EXPLORE,ENDPLUMED" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
