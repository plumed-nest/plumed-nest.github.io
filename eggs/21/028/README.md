...
**Last tested:**  15 Jan 2026, 17:14:32
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,LOWER_WALLS,DISTANCE,WHOLEMOLECULES,DISTANCES,PYTORCH_MODEL,UPPER_WALLS,TORSION,ENDPLUMED,MATHEVAL,COORDINATION,FIXEDATOM,ANGLE,FIT_TO_TEMPLATE,OPES_METAD,UNITS,CENTER,LOAD,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
