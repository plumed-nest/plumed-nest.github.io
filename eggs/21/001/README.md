...
**Last tested:**  03 Feb 2026, 21:16:56
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=INCLUDE,PUCKERING,UPPER_WALLS,RANDOM_EXCHANGES,METAD,REWEIGHT_METAD,DISTANCE,PRINT,ENERGY,HISTOGRAM,COORDINATION,MOLINFO,GROUP,WHOLEMOLECULES,DUMPGRID,LOWER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
