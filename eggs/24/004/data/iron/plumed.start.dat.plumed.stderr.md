...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.6dB8bI.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.6dB8bI.cpp:45:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.6dB8bI.cpp:45:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
45 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.6dB8bI.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.6dB8bI.cpp:81:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
81 |   bool serial,pbc;
|               ^~~
Graph.6dB8bI.cpp:81:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
81 |   bool serial,pbc;
|        ^~~~~~
Graph.6dB8bI.cpp:106:1: warning:   when initialized here [-Wreorder]
106 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.6dB8bI.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.6dB8bI.cpp:176:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.6dB8bI.cpp:177:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
177 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.6dB8bI.cpp:182:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
182 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.6dB8bI.cpp:183:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
183 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.6dB8bI.cpp:186:3: error: ‘Matrix’ was not declared in this scope
186 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.6dB8bI.cpp:186:10: error: expected primary-expression before ‘double’
186 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.6dB8bI.cpp:187:10: error: expected primary-expression before ‘double’
187 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.6dB8bI.cpp:188:16: error: expected primary-expression before ‘>’ token
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.6dB8bI.cpp:188:18: error: ‘dist_deriv_mat’ was not declared in this scope
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.6dB8bI.cpp:208:11: error: ‘dist_mat’ was not declared in this scope
208 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.6dB8bI.cpp:209:11: error: ‘idxn_mat’ was not declared in this scope
209 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.6dB8bI.cpp:215:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
215 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.6dB8bI.cpp:215:18: error: ‘dist_mat’ was not declared in this scope
215 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.6dB8bI.cpp:216:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
216 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.6dB8bI.cpp:216:18: error: ‘idxn_mat’ was not declared in this scope
216 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.6dB8bI.cpp:217:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
217 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.6dB8bI.cpp:221:25: error: ‘dist_mat’ was not declared in this scope
221 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.6dB8bI.cpp:222:25: error: ‘idxn_mat’ was not declared in this scope
222 |   vector<double> input2=idxn_mat.getVector();
|                         ^~~~~~~~
Graph.6dB8bI.cpp:269:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[fv-az1921-959:63395] *** Process received signal ***
[fv-az1921-959:63395] Signal: Aborted (6)
[fv-az1921-959:63395] Signal code:  (-6)
[fv-az1921-959:63395] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fe01b045330]
[fv-az1921-959:63395] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fe01b09eb2c]
[fv-az1921-959:63395] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fe01b04527e]
[fv-az1921-959:63395] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fe01b0288ff]
[fv-az1921-959:63395] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fe01b4a5ff5]
[fv-az1921-959:63395] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fe01b4bb0da]
[fv-az1921-959:63395] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fe01b4a5a55]
[fv-az1921-959:63395] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fe01b4a5a6f]
[fv-az1921-959:63395] [ 8] plumed(+0x146dd)[0x5596655b86dd]
[fv-az1921-959:63395] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fe01b02a1ca]
[fv-az1921-959:63395] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fe01b02a28b]
[fv-az1921-959:63395] [11] plumed(+0x15365)[0x5596655b9365]
[fv-az1921-959:63395] *** End of error message ***
</pre>
{% endraw %}
