...
**Last tested:**  29 Jun 2026, 10:21:59
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=ENDPLUMED,COMMITTOR,GROUP,FIT_TO_TEMPLATE,LOAD,ENERGY,FIXEDATOM,MATHEVAL,CENTER,COORDINATION,ANGLE,UPPER_WALLS,PRINT,DISTANCE,FLUSH,PYTORCH_MODEL,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
