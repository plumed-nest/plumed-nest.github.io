...
**Last tested:**  06 May 2025, 06:45:27
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DISTANCE,PYTORCH_MODEL,FIXEDATOM,LOWER_WALLS,GROUP,TORSION,PATH,UPPER_WALLS,PRINT,WHOLEMOLECULES,RESTART,COORDINATION,CENTER,FIT_TO_TEMPLATE,CUSTOM,OPES_METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
