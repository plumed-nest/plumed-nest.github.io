...
**Last tested:**  25 Jul 2025, 11:31:15
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,FIXEDATOM,COORDINATION,CENTER,WHOLEMOLECULES,CUSTOM,OPES_METAD,RESTART,PRINT,GROUP,DISTANCE,LOWER_WALLS,PYTORCH_MODEL,TORSION,PATH,UPPER_WALLS" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
