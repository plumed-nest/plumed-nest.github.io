...
**Last tested:**  21 Jun 2025, 13:36:41
  
**Project description and instructions**  
Initial configurations, run files for GROMACS and two complete examples of metadynamics are included.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MOLINFO,PRINT,DISTANCE,LOWER_WALLS,GYRATION,COM,UPPER_WALLS,PBMETAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
