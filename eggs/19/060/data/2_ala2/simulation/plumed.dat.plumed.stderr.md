...
from ../../0_code/NeuralNetworkVes.GRxZIT.cpp:32:
...
from ../../0_code/NeuralNetworkVes.GRxZIT.cpp:25:
...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp: In function ‘std::vector<float, std::allocator<float> > PLMD::bias::tensor_to_vector(const at::Tensor&)’:
../../0_code/NeuralNetworkVes.GRxZIT.cpp:66:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp:66:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
66 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp: In function ‘std::vector<double> PLMD::bias::tensor_to_vector_d(const at::Tensor&)’:
../../0_code/NeuralNetworkVes.GRxZIT.cpp:69:45: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
69 |     return std::vector<double>(x.data<float>(), x.data<float>() + x.numel());
|                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp:69:62: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
69 |     return std::vector<double>(x.data<float>(), x.data<float>() + x.numel());
|                                                 ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp: In member function ‘void PLMD::bias::Net::setRange(std::vector<std::__cxx11::basic_string<char> >, std::vector<std::__cxx11::basic_string<char> >)’:
../../0_code/NeuralNetworkVes.GRxZIT.cpp:162:47: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
162 |     _mean = torch::tensor(mean).view({1,m.size()});
|                                         ~~~~~~^~
../../0_code/NeuralNetworkVes.GRxZIT.cpp:162:47: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
../../0_code/NeuralNetworkVes.GRxZIT.cpp:163:57: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
163 |     _inv_range = torch::tensor(inv_range).view({1,m.size()});
|                                                   ~~~~~~^~
../../0_code/NeuralNetworkVes.GRxZIT.cpp:163:57: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
../../0_code/NeuralNetworkVes.GRxZIT.cpp: In static member function ‘static void PLMD::bias::NeuralNetworkVes::registerKeywords(PLMD::Keywords&)’:
../../0_code/NeuralNetworkVes.GRxZIT.cpp:289:3: error: ‘componentsAreNotOptional’ was not declared in this scope
289 |   componentsAreNotOptional(keys);
|   ^~~~~~~~~~~~~~~~~~~~~~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp: In constructor ‘PLMD::bias::NeuralNetworkVes::NeuralNetworkVes(const PLMD::ActionOptions&)’:
../../0_code/NeuralNetworkVes.GRxZIT.cpp:319:46: warning: ‘double PLMD::PlumedMain::DeprecatedAtoms::getKBoltzmann() const’ is deprecated: Use Action::getKBoltzmann(). [-Wdeprecated-declarations]
319 |   double Kb = plumed.getAtoms().getKBoltzmann();
|               ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
In file included from ../../0_code/NeuralNetworkVes.GRxZIT.cpp:26:
/home/runner/opt/include/plumed/core/PlumedMain.h:102:12: note: declared here
102 |     double getKBoltzmann() const ;
|            ^~~~~~~~~~~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp:320:47: warning: ‘double PLMD::PlumedMain::DeprecatedAtoms::getKBoltzmann() const’ is deprecated: Use Action::getKBoltzmann(). [-Wdeprecated-declarations]
320 |   double KbT = plumed.getAtoms().getKBoltzmann()*temp;
|                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
/home/runner/opt/include/plumed/core/PlumedMain.h:102:12: note: declared here
102 |     double getKBoltzmann() const ;
|            ^~~~~~~~~~~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp:322:33: warning: ‘double PLMD::PlumedMain::DeprecatedAtoms::getKbT() const’ is deprecated: Use Action::getkBT() N.B. this function also reads the TEMP keyword from the input for you. [-Wdeprecated-declarations]
322 |     KbT=plumed.getAtoms().getKbT();
|         ~~~~~~~~~~~~~~~~~~~~~~~~^~
/home/runner/opt/include/plumed/core/PlumedMain.h:104:12: note: declared here
104 |     double getKbT() const ;
|            ^~~~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp:366:8: warning: unused variable ‘sparsegrid’ [-Wunused-variable]
366 |   bool sparsegrid=false;
|        ^~~~~~~~~~
../../0_code/NeuralNetworkVes.GRxZIT.cpp: In instantiation of ‘std::vector<_Tp> PLMD::bias::operator*(Q, std::vector<_Tp>) [with T = float; Q = double]’:
../../0_code/NeuralNetworkVes.GRxZIT.cpp:664:44:   required from here
../../0_code/NeuralNetworkVes.GRxZIT.cpp:62:31: warning: ‘std::binder1st<_Operation> std::bind1st(const _Operation&, const _Tp&) [with _Operation = multiplies<float>; _Tp = double]’ is deprecated: use 'std::bind' instead [-Wdeprecated-declarations]
...
[runnervmw9dnm:13233] *** Process received signal ***
[runnervmw9dnm:13233] Signal: Aborted (6)
[runnervmw9dnm:13233] Signal code:  (-6)
[runnervmw9dnm:13233] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f879a845330]
[runnervmw9dnm:13233] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f879a89eb2c]
[runnervmw9dnm:13233] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f879a84527e]
[runnervmw9dnm:13233] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f879a8288ff]
[runnervmw9dnm:13233] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f879aca5ff5]
[runnervmw9dnm:13233] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f879acbb0da]
[runnervmw9dnm:13233] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f879aca5a55]
[runnervmw9dnm:13233] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f879aca5a6f]
[runnervmw9dnm:13233] [ 8] plumed(+0x146dd)[0x56203a5aa6dd]
[runnervmw9dnm:13233] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f879a82a1ca]
[runnervmw9dnm:13233] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f879a82a28b]
[runnervmw9dnm:13233] [11] plumed(+0x15365)[0x56203a5ab365]
[runnervmw9dnm:13233] *** End of error message ***
</pre>
{% endraw %}
