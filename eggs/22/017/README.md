...
**Last tested:**  22 May 2025, 18:07:18
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIT_TO_TEMPLATE,COORDINATION,DISTANCE,OPES_METAD,WHOLEMOLECULES,LOWER_WALLS,MATHEVAL,COMMITTOR,RMSD,PRINT,UPPER_WALLS,FIXEDATOM,CUSTOM,CENTER,PYTORCH_MODEL,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
