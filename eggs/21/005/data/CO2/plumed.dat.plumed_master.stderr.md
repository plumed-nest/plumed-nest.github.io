...
from ../codes/StructureFactor_descriptor.test.K43MVp.cpp:6:
...
|
../codes/StructureFactor_descriptor.test.K43MVp.cpp: In static member function ‘static void PLMD::colvar::StructureFactor_descriptor_test::registerKeywords(PLMD::Keywords&)’:
../codes/StructureFactor_descriptor.test.K43MVp.cpp:77:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
../codes/StructureFactor_descriptor.test.K43MVp.cpp: In constructor ‘PLMD::colvar::StructureFactor_descriptor_test::StructureFactor_descriptor_test(const PLMD::ActionOptions&)’:
../codes/StructureFactor_descriptor.test.K43MVp.cpp:188:41: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
188 |     NumAtom_=plumed.getAtoms().getNatoms();
|              ~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
In file included from ../codes/StructureFactor_descriptor.test.K43MVp.cpp:8:
/home/runner/opt/include/plumed_master/core/PlumedMain.h:106:9: note: declared here
106 |     int getNatoms() const ;
|         ^~~~~~~~~
../codes/StructureFactor_descriptor.test.K43MVp.cpp:194:108: warning: ‘int PLMD::PlumedMain::DeprecatedAtoms::getNatoms() const’ is deprecated [-Wdeprecated-declarations]
...
|         ^~~~~~~~~
Assembler messages:
Fatal error: can't create plumed_mklib.PpGvtc/../codes/StructureFactor_descriptor.test.o: No such file or directory
...
[pkrvmq0rgcvqdmg:12759] *** Process received signal ***
[pkrvmq0rgcvqdmg:12759] Signal: Aborted (6)
[pkrvmq0rgcvqdmg:12759] Signal code:  (-6)
[pkrvmq0rgcvqdmg:12759] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7fd647645330]
[pkrvmq0rgcvqdmg:12759] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7fd64769eb2c]
[pkrvmq0rgcvqdmg:12759] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7fd64764527e]
[pkrvmq0rgcvqdmg:12759] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7fd6476288ff]
[pkrvmq0rgcvqdmg:12759] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7fd647aa5ff5]
[pkrvmq0rgcvqdmg:12759] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7fd647abb0da]
[pkrvmq0rgcvqdmg:12759] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7fd647aa5a55]
[pkrvmq0rgcvqdmg:12759] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7fd647aa5a6f]
[pkrvmq0rgcvqdmg:12759] [ 8] plumed_master(+0x146dd)[0x55f34722e6dd]
[pkrvmq0rgcvqdmg:12759] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7fd64762a1ca]
[pkrvmq0rgcvqdmg:12759] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7fd64762a28b]
[pkrvmq0rgcvqdmg:12759] [11] plumed_master(+0x15365)[0x55f34722f365]
[pkrvmq0rgcvqdmg:12759] *** End of error message ***
</pre>
{% endraw %}
