...
**Last tested:**  27 Jul 2026, 19:16:06
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MATHEVAL,COM,ENERGY,FUNNEL,WHOLEMOLECULES,GROUP,DISTANCE,COORDINATION,METAD,WRAPAROUND,PYTORCH_MODEL,UPPER_WALLS,FUNNEL_PS,LOWER_WALLS,PRINT,RMSD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
