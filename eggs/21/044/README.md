...
**Last tested:**  06 May 2025, 07:00:48
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CONTACT_MATRIX,MFILTER_MORE,COORDINATIONNUMBER,CLUSTER_DISTRIBUTION,Q6,LOCAL_Q6,METAD,INSPHERE,DFSCLUSTERING,HISTOGRAM,FIXEDATOM,CLUSTER_NATOMS,COMBINE,GROUP,PRINT,DUMPGRID" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
