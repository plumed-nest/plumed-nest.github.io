...
**Last tested:**  10 Mar 2026, 11:12:13
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COM,COORDINATION,OPES_METAD_EXPLORE,GROUP,DISTANCE,PRINT,UPPER_WALLS,METAD,CUSTOM,CENTER,LOWER_WALLS,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
