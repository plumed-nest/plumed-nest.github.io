...
**Last tested:**  29 May 2025, 07:07:24
  
**Project description and instructions**  
PLUMED files contain everything needed to reproduce parallel bias metadynamics on 2,3,4-mer helical peptoids.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=RESTRAINT,GYRATION,WHOLEMOLECULES,COORDINATION,PBMETAD,PRINT,INCLUDE,TORSION,COM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
