...
**Last tested:**  06 May 2025, 07:10:01
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=GROUP,CONTACT_MATRIX,LOAD,AROUND,CLUSTER_DISTRIBUTION,COORDINATIONNUMBER,DENSITY,PRINT,RESTRAINT,MFILTER_MORE,MULTICOLVARDENS,DFSCLUSTERING,DUMPGRID,CLUSTER_NATOMS,FIXEDATOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
