...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PYTORCH_MODEL,DISTANCE,FIXEDATOM,TORSION,OPES_METAD,FIT_TO_TEMPLATE,CENTER,GROUP,PATH,UPPER_WALLS,UNITS,WHOLEMOLECULES,OPES_METAD_EXPLORE,CUSTOM,LOWER_WALLS,COORDINATION,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
