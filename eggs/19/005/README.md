...
**Last tested:**  10 Mar 2026, 11:24:08
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PBMETAD,COORDINATION,GROUP,DISTANCE,CS2BACKBONE,METAINFERENCE,ALPHABETA,MOLINFO,CENTER,WHOLEMOLECULES,GYRATION,PRINT,INCLUDE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
