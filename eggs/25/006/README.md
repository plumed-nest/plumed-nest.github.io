...
**Last tested:**  20 Apr 2026, 09:17:11
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PBMETAD,INCLUDE,TORSION,PRINT,ENERGY,RESTART,READ,DUMPATOMS,MOLINFO,VOLUME,CENTER,UPDATE_IF,DISTANCE,WHOLEMOLECULES,GYRATION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
