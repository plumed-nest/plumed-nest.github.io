...
**Last tested:**  01 Sep 2026, 14:19:41
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=OPES_METAD_EXPLORE,PRINT,METAD,COORDINATION,DISTANCE,UPPER_WALLS,COM,CENTER,LOWER_WALLS,CUSTOM,WHOLEMOLECULES,GROUP" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
