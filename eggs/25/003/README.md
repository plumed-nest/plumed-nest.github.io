...
**Last tested:**  01 Sep 2026, 14:20:39
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=WHOLEMOLECULES,MOLINFO,GROUP,COMMITTOR,DISTANCE,TORSION,MATHEVAL,ENERGY,CUSTOM,PYTORCH_MODEL,OPES_METAD,COMBINE,ENDPLUMED,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
