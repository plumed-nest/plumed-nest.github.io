...
**Last tested:**  11 Nov 2025, 10:01:59
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=FIXEDATOM,CLUSTER_DISTRIBUTION,COMBINE,METAD,PRINT,MFILTER_MORE,GROUP,CONTACT_MATRIX,CLUSTER_NATOMS,COORDINATIONNUMBER,DUMPGRID,DFSCLUSTERING,LOCAL_Q6,HISTOGRAM,INSPHERE,Q6" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
