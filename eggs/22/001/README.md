...
**Last tested:**  22 May 2025, 18:18:34
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=VES_OUTPUT_BASISFUNCTIONS,INCLUDE,OPT_AVERAGED_SGD,DISTANCE,ENERGY,PRINT,BF_CUBIC_B_SPLINES,UPPER_WALLS,COORDINATION,TD_UNIFORM,POSITION,OPT_ADAM,BF_CHEBYSHEV,BF_LEGENDRE,BF_WAVELETS,FLUSH,METAD,BF_GAUSSIANS,UNITS,TD_WELLTEMPERED,VES_LINEAR_EXPANSION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
