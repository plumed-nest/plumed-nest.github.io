...
**Last tested:**  20 Apr 2026, 09:18:33
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CUSTOM,COORDINATION,METAD,UPPER_WALLS,DISTANCE,OPES_METAD_EXPLORE,GROUP,WHOLEMOLECULES,COM,LOWER_WALLS,CENTER,PRINT" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
