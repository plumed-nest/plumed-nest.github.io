...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CONSTANT,GROUP,TORSION,DISTANCE,UNITS,POSITION,PRINT,COMBINE,CUSTOM,BIASVALUE,PYTORCH_MODEL,WHOLEMOLECULES,INCLUDE,CONTACTMAP,ENERGY,COMMITTOR,MOLINFO,OPES_METAD,ENDPLUMED,RMSD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
