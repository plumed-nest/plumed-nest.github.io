...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DUMPGRID,RESTART,PRINT,UPPER_WALLS,COORDINATION,CUSTOM,REWEIGHT_METAD,HISTOGRAM,GROUP,FLUSH,DISTANCE,METAD,READ" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
