...
**Last tested:**  15 May 2025, 08:15:41
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CUSTOM,GROUP,FIXEDATOM,OPES_METAD,COORDINATION,UPPER_WALLS,UNITS,CENTER,PATH,TORSION,DISTANCE,LOWER_WALLS,PRINT,PYTORCH_MODEL,FIT_TO_TEMPLATE,OPES_METAD_EXPLORE,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
