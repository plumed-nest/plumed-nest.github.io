...
**Last tested:**  10 Mar 2026, 11:21:01
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=LOCAL_Q6,ONES,CONTACT_MATRIX,OUTER_PRODUCT,MORE_THAN,Q6,MATRIX_VECTOR_PRODUCT,DFSCLUSTERING,OUTPUT_CLUSTER,PRINT,CLUSTER_DISTRIBUTION,COORDINATIONNUMBER,METAD,SMAC,DISTANCES,CLUSTER_NATOMS,CUSTOM,CLUSTER_PROPERTIES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
