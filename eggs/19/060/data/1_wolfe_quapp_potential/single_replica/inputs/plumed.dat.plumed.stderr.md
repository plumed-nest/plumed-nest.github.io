...
from ../../../0_code/NeuralNetworkVes.3yeLHS.cpp:32:
...
from ../../../0_code/NeuralNetworkVes.3yeLHS.cpp:25:
...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp: In function ‘std::vector<float, std::allocator<float> > PLMD::bias::tensor_to_vector(const at::Tensor&)’:
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:66:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:66:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
66 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp: In function ‘std::vector<double> PLMD::bias::tensor_to_vector_d(const at::Tensor&)’:
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:69:45: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
69 |     return std::vector<double>(x.data<float>(), x.data<float>() + x.numel());
|                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:69:62: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
69 |     return std::vector<double>(x.data<float>(), x.data<float>() + x.numel());
|                                                 ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp: In member function ‘void PLMD::bias::Net::setRange(std::vector<std::__cxx11::basic_string<char> >, std::vector<std::__cxx11::basic_string<char> >)’:
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:162:47: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
162 |     _mean = torch::tensor(mean).view({1,m.size()});
|                                         ~~~~~~^~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:162:47: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:163:57: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
163 |     _inv_range = torch::tensor(inv_range).view({1,m.size()});
|                                                   ~~~~~~^~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:163:57: warning: narrowing conversion of ‘m.std::vector<std::__cxx11::basic_string<char> >::size()’ from ‘std::vector<std::__cxx11::basic_string<char> >::size_type’ {aka ‘long unsigned int’} to ‘long int’ [-Wnarrowing]
../../../0_code/NeuralNetworkVes.3yeLHS.cpp: In static member function ‘static void PLMD::bias::NeuralNetworkVes::registerKeywords(PLMD::Keywords&)’:
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:289:3: error: ‘componentsAreNotOptional’ was not declared in this scope
289 |   componentsAreNotOptional(keys);
|   ^~~~~~~~~~~~~~~~~~~~~~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp: In constructor ‘PLMD::bias::NeuralNetworkVes::NeuralNetworkVes(const PLMD::ActionOptions&)’:
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:319:46: warning: ‘double PLMD::PlumedMain::DeprecatedAtoms::getKBoltzmann() const’ is deprecated: Use Action::getKBoltzmann(). [-Wdeprecated-declarations]
319 |   double Kb = plumed.getAtoms().getKBoltzmann();
|               ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
In file included from ../../../0_code/NeuralNetworkVes.3yeLHS.cpp:26:
/home/runner/opt/include/plumed/core/PlumedMain.h:102:12: note: declared here
102 |     double getKBoltzmann() const ;
|            ^~~~~~~~~~~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:320:47: warning: ‘double PLMD::PlumedMain::DeprecatedAtoms::getKBoltzmann() const’ is deprecated: Use Action::getKBoltzmann(). [-Wdeprecated-declarations]
320 |   double KbT = plumed.getAtoms().getKBoltzmann()*temp;
|                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
/home/runner/opt/include/plumed/core/PlumedMain.h:102:12: note: declared here
102 |     double getKBoltzmann() const ;
|            ^~~~~~~~~~~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:322:33: warning: ‘double PLMD::PlumedMain::DeprecatedAtoms::getKbT() const’ is deprecated: Use Action::getkBT() N.B. this function also reads the TEMP keyword from the input for you. [-Wdeprecated-declarations]
322 |     KbT=plumed.getAtoms().getKbT();
|         ~~~~~~~~~~~~~~~~~~~~~~~~^~
/home/runner/opt/include/plumed/core/PlumedMain.h:104:12: note: declared here
104 |     double getKbT() const ;
|            ^~~~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:366:8: warning: unused variable ‘sparsegrid’ [-Wunused-variable]
366 |   bool sparsegrid=false;
|        ^~~~~~~~~~
../../../0_code/NeuralNetworkVes.3yeLHS.cpp: In instantiation of ‘std::vector<_Tp> PLMD::bias::operator*(Q, std::vector<_Tp>) [with T = float; Q = double]’:
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:664:44:   required from here
../../../0_code/NeuralNetworkVes.3yeLHS.cpp:62:31: warning: ‘std::binder1st<_Operation> std::bind1st(const _Operation&, const _Tp&) [with _Operation = multiplies<float>; _Tp = double]’ is deprecated: use 'std::bind' instead [-Wdeprecated-declarations]
...
[fv-az797-511:10881] *** Process received signal ***
[fv-az797-511:10881] Signal: Aborted (6)
[fv-az797-511:10881] Signal code:  (-6)
[fv-az797-511:10881] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f9a84445330]
[fv-az797-511:10881] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f9a8449eb2c]
[fv-az797-511:10881] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f9a8444527e]
[fv-az797-511:10881] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f9a844288ff]
[fv-az797-511:10881] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f9a848a5ff5]
[fv-az797-511:10881] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f9a848bb0da]
[fv-az797-511:10881] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f9a848a5a55]
[fv-az797-511:10881] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f9a848a5a6f]
[fv-az797-511:10881] [ 8] plumed(+0x146dd)[0x561e929b86dd]
[fv-az797-511:10881] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f9a8442a1ca]
[fv-az797-511:10881] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f9a8442a28b]
[fv-az797-511:10881] [11] plumed(+0x15365)[0x561e929b9365]
[fv-az797-511:10881] *** End of error message ***
</pre>
{% endraw %}
