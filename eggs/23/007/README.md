...
**Last tested:**  03 Jul 2025, 13:20:44
  
**Project description and instructions**  
PLUMED files contain everything needed to reproduce parallel bias metadynamics on 2,3,4-mer helical peptoids.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=RESTRAINT,PBMETAD,PRINT,GYRATION,COORDINATION,INCLUDE,WHOLEMOLECULES,COM,TORSION" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
