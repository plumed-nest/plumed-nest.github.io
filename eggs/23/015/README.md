...
**Last tested:**  17 Jul 2025, 15:07:45
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=UPPER_WALLS,PRINT,LOWER_WALLS,COM,OPES_METAD_EXPLORE,COORDINATION,DISTANCE,CUSTOM,GROUP,CENTER,WHOLEMOLECULES,METAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
