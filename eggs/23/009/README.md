...
**Last tested:**  01 Sep 2026, 14:33:22
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=CONTACTMAP,FIXEDATOM,FIT_TO_TEMPLATE,CUSTOM,COORDINATION,DISTANCE,ANGLE,PYTORCH_MODEL,COMMITTOR,ENDPLUMED,ENERGY,RMSD,OPES_METAD,PRINT,MOLINFO,LOWER_WALLS,CENTER,GROUP,UPPER_WALLS,MATHEVAL,COMBINE,INCLUDE,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
