...
**Last tested:**  22 May 2025, 18:09:19
  
**Project description and instructions**  
Input files are prepared in gromacs version 2021.4 and plumed2 version 2.8.0.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=METAD,UPPER_WALLS,PRINT,COORDINATION,OPES_METAD_EXPLORE,LOWER_WALLS,CUSTOM,GROUP,DISTANCE,CENTER,COM,WHOLEMOLECULES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
